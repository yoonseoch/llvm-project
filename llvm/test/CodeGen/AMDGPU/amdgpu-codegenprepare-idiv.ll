...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]], i32 [[Y:%.*]]) {
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i16 [[X:%.*]], i16 [[Y:%.*]]) {
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i8 [[X:%.*]], i8 [[Y:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @srem_i8(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i8 [[X:%.*]], i8 [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = sext i8 [[X]] to i32
; CHECK-NEXT:    [[TMP2:%.*]] = sext i8 [[Y]] to i32
; CHECK-NEXT:    [[TMP6:%.*]] = sitofp fast i32 [[TMP1]] to float
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_v4i32(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <4 x i32> [[X:%.*]], <4 x i32> [[Y:%.*]]) {
...
; GFX6-NEXT:    s_load_dwordx2 s[16:17], s[4:5], 0x9
...
; GFX6-NEXT:    v_cndmask_b32_e64 v1, v1, v4, s[2:3]
...
; GFX9-NEXT:    s_mul_hi_u32 s2, s8, s3
; GFX9-NEXT:    s_mul_i32 s3, s2, s12
; GFX9-NEXT:    s_sub_i32 s3, s8, s3
; GFX9-NEXT:    s_add_i32 s5, s2, 1
; GFX9-NEXT:    s_sub_i32 s6, s3, s12
; GFX9-NEXT:    s_cmp_ge_u32 s3, s12
; GFX9-NEXT:    s_cselect_b32 s2, s5, s2
...
; GFX9-NEXT:    s_cmp_ge_u32 s5, s14
; GFX9-NEXT:    s_cselect_b32 s4, s6, s4
; GFX9-NEXT:    s_sub_i32 s5, 0, s15
; GFX9-NEXT:    v_readfirstlane_b32 s6, v0
; GFX9-NEXT:    s_mul_i32 s5, s5, s6
; GFX9-NEXT:    s_mul_hi_u32 s5, s6, s5
; GFX9-NEXT:    s_add_i32 s6, s6, s5
; GFX9-NEXT:    s_mul_hi_u32 s5, s11, s6
; GFX9-NEXT:    s_mul_i32 s6, s5, s15
; GFX9-NEXT:    s_sub_i32 s6, s11, s6
; GFX9-NEXT:    s_add_i32 s7, s5, 1
; GFX9-NEXT:    s_sub_i32 s8, s6, s15
; GFX9-NEXT:    s_cmp_ge_u32 s6, s15
; GFX9-NEXT:    s_cselect_b32 s5, s7, s5
...
; CHECK-LABEL: define amdgpu_kernel void @urem_v4i32(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <4 x i32> [[X:%.*]], <4 x i32> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <4 x i32> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <4 x i32> [[Y]], i64 0
; CHECK-NEXT:    [[TMP3:%.*]] = uitofp fast i32 [[TMP2]] to float
...
; GFX6-NEXT:    v_mul_f32_e32 v1, 0x4f7ffffe, v2
; GFX6-NEXT:    v_cvt_u32_f32_e32 v1, v1
; GFX6-NEXT:    v_cvt_f32_u32_e32 v2, s15
; GFX6-NEXT:    v_readfirstlane_b32 s0, v0
; GFX6-NEXT:    s_mul_i32 s0, s0, s13
; GFX6-NEXT:    s_sub_i32 s0, s9, s0
; GFX6-NEXT:    s_sub_i32 s1, s0, s13
; GFX6-NEXT:    s_cmp_ge_u32 s0, s13
; GFX6-NEXT:    s_cselect_b32 s0, s1, s0
; GFX6-NEXT:    s_sub_i32 s1, s0, s13
; GFX6-NEXT:    s_cmp_ge_u32 s0, s13
...
; GFX6-NEXT:    v_cvt_u32_f32_e32 v1, v1
; GFX6-NEXT:    v_readfirstlane_b32 s0, v0
; GFX6-NEXT:    s_mul_i32 s0, s0, s14
; GFX6-NEXT:    s_sub_i32 s0, s10, s0
; GFX6-NEXT:    s_sub_i32 s1, s0, s14
; GFX6-NEXT:    s_cmp_ge_u32 s0, s14
; GFX6-NEXT:    s_cselect_b32 s0, s1, s0
; GFX6-NEXT:    s_sub_i32 s1, s0, s14
; GFX6-NEXT:    s_cmp_ge_u32 s0, s14
; GFX6-NEXT:    s_cselect_b32 s8, s1, s0
; GFX6-NEXT:    s_sub_i32 s0, 0, s15
; GFX6-NEXT:    v_mul_lo_u32 v0, s0, v1
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX6-NEXT:    v_mul_hi_u32 v0, v1, v0
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; GFX6-NEXT:    v_mul_hi_u32 v2, s11, v0
; GFX6-NEXT:    v_mov_b32_e32 v0, s6
; GFX6-NEXT:    v_mov_b32_e32 v1, s7
; GFX6-NEXT:    v_readfirstlane_b32 s4, v2
; GFX6-NEXT:    s_mul_i32 s4, s4, s15
; GFX6-NEXT:    s_sub_i32 s4, s11, s4
; GFX6-NEXT:    s_sub_i32 s5, s4, s15
; GFX6-NEXT:    s_cmp_ge_u32 s4, s15
...
; GFX9-NEXT:    s_sub_i32 s3, s2, s12
; GFX9-NEXT:    s_cmp_ge_u32 s2, s12
...
; GFX9-NEXT:    s_add_i32 s4, s4, s3
; GFX9-NEXT:    s_mul_hi_u32 s3, s9, s4
; GFX9-NEXT:    s_mul_i32 s3, s3, s13
; GFX9-NEXT:    s_sub_i32 s3, s9, s3
; GFX9-NEXT:    s_sub_i32 s4, s3, s13
; GFX9-NEXT:    v_cvt_u32_f32_e32 v2, v2
; GFX9-NEXT:    s_cmp_ge_u32 s3, s13
...
; GFX9-NEXT:    s_sub_i32 s5, s4, s14
; GFX9-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX9-NEXT:    s_cmp_ge_u32 s4, s14
; GFX9-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GFX9-NEXT:    s_add_i32 s6, s6, s5
; GFX9-NEXT:    s_mul_hi_u32 s5, s11, s6
; GFX9-NEXT:    s_mul_i32 s5, s5, s15
; GFX9-NEXT:    s_sub_i32 s5, s11, s5
; GFX9-NEXT:    s_sub_i32 s6, s5, s15
; GFX9-NEXT:    s_cmp_ge_u32 s5, s15
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_v4i32(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <4 x i32> [[X:%.*]], <4 x i32> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <4 x i32> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <4 x i32> [[Y]], i64 0
...
; GFX6-NEXT:    s_mul_i32 s2, s2, s0
; GFX6-NEXT:    s_sub_i32 s1, s1, s2
; GFX6-NEXT:    s_sub_i32 s2, s1, s0
...
; CHECK-LABEL: define amdgpu_kernel void @srem_v4i32(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <4 x i32> [[X:%.*]], <4 x i32> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <4 x i32> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <4 x i32> [[Y]], i64 0
; CHECK-NEXT:    [[TMP3:%.*]] = ashr i32 [[TMP1]], 31
...
; GFX6-NEXT:    s_sub_i32 s3, s1, s0
; GFX6-NEXT:    s_cmp_ge_u32 s1, s0
; GFX6-NEXT:    s_cselect_b32 s0, s3, s1
; GFX6-NEXT:    s_abs_i32 s1, s13
; GFX6-NEXT:    v_cvt_f32_u32_e32 v0, s1
...
; GFX6-NEXT:    v_readfirstlane_b32 s0, v0
; GFX6-NEXT:    s_mul_i32 s0, s0, s1
; GFX6-NEXT:    s_sub_i32 s0, s3, s0
; GFX6-NEXT:    s_sub_i32 s2, s0, s1
; GFX6-NEXT:    s_cmp_ge_u32 s0, s1
; GFX6-NEXT:    s_cselect_b32 s0, s2, s0
; GFX6-NEXT:    s_sub_i32 s2, s0, s1
; GFX6-NEXT:    s_cmp_ge_u32 s0, s1
; GFX6-NEXT:    s_cselect_b32 s0, s2, s0
; GFX6-NEXT:    s_abs_i32 s1, s14
; GFX6-NEXT:    v_cvt_f32_u32_e32 v0, s1
...
; GFX6-NEXT:    s_mul_i32 s7, s7, s10
; GFX6-NEXT:    s_sub_i32 s4, s4, s7
; GFX6-NEXT:    s_sub_i32 s7, s4, s10
; GFX6-NEXT:    s_cmp_ge_u32 s4, s10
...
; GFX9-NEXT:    s_sub_i32 s0, s6, s0
; GFX9-NEXT:    s_sub_i32 s6, s0, s1
; GFX9-NEXT:    s_cmp_ge_u32 s0, s1
; GFX9-NEXT:    s_cselect_b32 s0, s6, s0
; GFX9-NEXT:    s_sub_i32 s6, s0, s1
; GFX9-NEXT:    s_cmp_ge_u32 s0, s1
; GFX9-NEXT:    s_cselect_b32 s6, s6, s0
; GFX9-NEXT:    s_abs_i32 s7, s15
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_v4i16(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <4 x i16> [[X:%.*]], <4 x i16> [[Y:%.*]]) {
...
; GFX9-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX9-NEXT:    v_cvt_u32_f32_e32 v1, v1
; GFX9-NEXT:    v_cvt_u32_f32_sdwa v3, v3 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
...
; CHECK-LABEL: define amdgpu_kernel void @urem_v4i16(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <4 x i16> [[X:%.*]], <4 x i16> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <4 x i16> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <4 x i16> [[Y]], i64 0
; CHECK-NEXT:    [[TMP3:%.*]] = zext i16 [[TMP1]] to i32
...
; GFX9-NEXT:    v_sub_u32_sdwa v5, s0, v1 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-NEXT:    v_sub_u32_e32 v1, s8, v3
; GFX9-NEXT:    v_sub_u32_sdwa v3, s1, v4 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-NEXT:    v_or_b32_sdwa v1, v3, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX9-NEXT:    v_or_b32_sdwa v0, v5, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_v4i16(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <4 x i16> [[X:%.*]], <4 x i16> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <4 x i16> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <4 x i16> [[Y]], i64 0
...
; GFX9-NEXT:    v_cvt_i32_f32_sdwa v3, v3 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
...
; CHECK-LABEL: define amdgpu_kernel void @srem_v4i16(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <4 x i16> [[X:%.*]], <4 x i16> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <4 x i16> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <4 x i16> [[Y]], i64 0
; CHECK-NEXT:    [[TMP3:%.*]] = sext i16 [[TMP1]] to i32
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_i3(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i3 [[X:%.*]], i3 [[Y:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @urem_i3(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i3 [[X:%.*]], i3 [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i3 [[X]] to i32
; CHECK-NEXT:    [[TMP2:%.*]] = zext i3 [[Y]] to i32
; CHECK-NEXT:    [[TMP3:%.*]] = uitofp fast i32 [[TMP1]] to float
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_i3(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i3 [[X:%.*]], i3 [[Y:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @srem_i3(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i3 [[X:%.*]], i3 [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = sext i3 [[X]] to i32
; CHECK-NEXT:    [[TMP2:%.*]] = sext i3 [[Y]] to i32
; CHECK-NEXT:    [[TMP6:%.*]] = sitofp fast i32 [[TMP1]] to float
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_v3i16(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <3 x i16> [[X:%.*]], <3 x i16> [[Y:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @urem_v3i16(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <3 x i16> [[X:%.*]], <3 x i16> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <3 x i16> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <3 x i16> [[Y]], i64 0
; CHECK-NEXT:    [[TMP3:%.*]] = zext i16 [[TMP1]] to i32
...
; GFX9-NEXT:    v_sub_u32_sdwa v2, s8, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_v3i16(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <3 x i16> [[X:%.*]], <3 x i16> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <3 x i16> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <3 x i16> [[Y]], i64 0
; CHECK-NEXT:    [[TMP3:%.*]] = sext i16 [[TMP1]] to i32
...
; CHECK-LABEL: define amdgpu_kernel void @srem_v3i16(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <3 x i16> [[X:%.*]], <3 x i16> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <3 x i16> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <3 x i16> [[Y]], i64 0
; CHECK-NEXT:    [[TMP3:%.*]] = sext i16 [[TMP1]] to i32
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_v3i15(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <3 x i15> [[X:%.*]], <3 x i15> [[Y:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @urem_v3i15(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <3 x i15> [[X:%.*]], <3 x i15> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <3 x i15> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <3 x i15> [[Y]], i64 0
; CHECK-NEXT:    [[TMP3:%.*]] = zext i15 [[TMP1]] to i32
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_v3i15(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <3 x i15> [[X:%.*]], <3 x i15> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <3 x i15> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <3 x i15> [[Y]], i64 0
...
; CHECK-LABEL: define amdgpu_kernel void @srem_v3i15(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <3 x i15> [[X:%.*]], <3 x i15> [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <3 x i15> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <3 x i15> [[Y]], i64 0
; CHECK-NEXT:    [[TMP3:%.*]] = sext i15 [[TMP1]] to i32
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_i32_oddk_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]]) {
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mul_hi_u32 v0, s6, v0
; GFX6-NEXT:    v_sub_i32_e32 v1, vcc, s6, v0
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mul_hi_u32 s3, s2, 0xb2a50881
; GFX9-NEXT:    s_sub_i32 s2, s2, s3
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_i32_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_i32_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]], i32 [[Y:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_v2i32_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_v2i32_mixed_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i32> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = udiv i32 [[TMP1]], 4096
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <2 x i32> poison, i32 [[TMP2]], i64 0
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_v2i32_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]], <2 x i32> [[Y:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @urem_i32_oddk_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @urem_i32_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @urem_i32_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]], i32 [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl i32 4096, [[Y]]
...
; CHECK-LABEL: define amdgpu_kernel void @urem_v2i32_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i32> [[X]], i64 0
...
; CHECK-LABEL: define amdgpu_kernel void @urem_v2i32_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]], <2 x i32> [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl <2 x i32> splat (i32 4096), [[Y]]
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i32> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <2 x i32> [[SHL_Y]], i64 0
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_i32_oddk_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]]) {
...
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mul_hi_i32 v0, s6, v0
...
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mul_hi_i32 s3, s2, 0xd9528441
; GFX9-NEXT:    s_add_i32 s3, s3, s2
; GFX9-NEXT:    s_lshr_b32 s2, s3, 31
; GFX9-NEXT:    s_ashr_i32 s3, s3, 20
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_i32_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_i32_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]], i32 [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl i32 4096, [[Y]]
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_v2i32_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i32> [[X]], i64 0
...
; CHECK-LABEL: define amdgpu_kernel void @ssdiv_v2i32_mixed_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i32> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = sdiv i32 [[TMP1]], 4096
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <2 x i32> poison, i32 [[TMP2]], i64 0
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_v2i32_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]], <2 x i32> [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl <2 x i32> splat (i32 4096), [[Y]]
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i32> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <2 x i32> [[SHL_Y]], i64 0
...
; CHECK-LABEL: define amdgpu_kernel void @srem_i32_oddk_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]]) {
...
; GFX6-NEXT:    s_add_i32 s4, s4, s6
; GFX6-NEXT:    s_lshr_b32 s5, s4, 31
; GFX6-NEXT:    s_ashr_i32 s4, s4, 20
; GFX6-NEXT:    s_add_i32 s4, s4, s5
; GFX6-NEXT:    s_mul_i32 s4, s4, 0x12d8fb
; GFX6-NEXT:    s_sub_i32 s4, s6, s4
; GFX6-NEXT:    v_mov_b32_e32 v0, s4
; GFX6-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX6-NEXT:    s_endpgm
;
...
; CHECK-LABEL: define amdgpu_kernel void @srem_i32_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]]) {
...
; GFX9-NEXT:    s_and_b32 s3, s3, 0xfffff000
; GFX9-NEXT:    s_sub_i32 s2, s2, s3
; GFX9-NEXT:    v_mov_b32_e32 v1, s2
; GFX9-NEXT:    global_store_dword v0, v1, s[0:1]
; GFX9-NEXT:    s_endpgm
...
; CHECK-LABEL: define amdgpu_kernel void @srem_i32_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]], i32 [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl i32 4096, [[Y]]
...
; CHECK-LABEL: define amdgpu_kernel void @srem_v2i32_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i32> [[X]], i64 0
...
; CHECK-LABEL: define amdgpu_kernel void @srem_v2i32_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]], <2 x i32> [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl <2 x i32> splat (i32 4096), [[Y]]
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i32> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <2 x i32> [[SHL_Y]], i64 0
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_i64_oddk_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]]) {
...
; GFX9-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mul_hi_u32 s4, s2, 0x38f83e5
; GFX9-NEXT:    s_mul_i32 s5, s2, 0x38f83e5
; GFX9-NEXT:    s_mul_i32 s7, s3, 0x64c139ef
; GFX9-NEXT:    s_mul_hi_u32 s2, s2, 0x64c139ef
; GFX9-NEXT:    s_mul_hi_u32 s6, s3, 0x64c139ef
; GFX9-NEXT:    s_add_u32 s2, s7, s2
; GFX9-NEXT:    s_addc_u32 s6, s6, 0
; GFX9-NEXT:    s_add_u32 s2, s5, s2
; GFX9-NEXT:    s_addc_u32 s2, s4, 0
; GFX9-NEXT:    s_add_u32 s2, s6, s2
; GFX9-NEXT:    s_addc_u32 s4, 0, 0
; GFX9-NEXT:    s_mul_hi_u32 s5, s3, 0x38f83e5
; GFX9-NEXT:    s_mul_i32 s3, s3, 0x38f83e5
; GFX9-NEXT:    s_add_u32 s2, s3, s2
; GFX9-NEXT:    s_addc_u32 s2, s5, s4
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_i64_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_i64_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]], i64 [[Y:%.*]]) {
...
; GFX6-NEXT:    s_mov_b32 s5, s1
; GFX6-NEXT:    s_lshr_b64 s[0:1], s[2:3], s8
; GFX6-NEXT:    v_mov_b32_e32 v0, s0
; GFX6-NEXT:    v_mov_b32_e32 v1, s1
; GFX6-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX6-NEXT:    s_endpgm
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_v2i64_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]]) {
...
; GFX9-NEXT:    v_mov_b32_e32 v4, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_lshr_b64 s[0:1], s[0:1], 12
; GFX9-NEXT:    s_lshr_b64 s[2:3], s[2:3], 12
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    v_mov_b32_e32 v2, s2
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_v2i64_mixed_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i64> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = udiv i64 [[TMP1]], 4096
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <2 x i64> poison, i64 [[TMP2]], i64 0
...
; GFX6-NEXT:    s_mul_i32 s7, s11, 0x10010011
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, s7, v3
; GFX6-NEXT:    s_mul_i32 s6, s10, 0x100100
; GFX6-NEXT:    v_addc_u32_e32 v2, vcc, 0, v2, vcc
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, s6, v3
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, v2, v1
; GFX6-NEXT:    v_mul_hi_u32 v0, s11, v0
; GFX6-NEXT:    v_addc_u32_e64 v2, s[6:7], 0, 0, vcc
; GFX6-NEXT:    s_mul_i32 s6, s11, 0x100100
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, s6, v1
; GFX6-NEXT:    v_addc_u32_e32 v2, vcc, v0, v2, vcc
; GFX6-NEXT:    v_mov_b32_e32 v1, s11
; GFX6-NEXT:    v_sub_i32_e32 v0, vcc, s10, v3
; GFX6-NEXT:    v_subb_u32_e32 v1, vcc, v1, v2, vcc
; GFX6-NEXT:    v_lshr_b64 v[0:1], v[0:1], 1
; GFX6-NEXT:    s_lshr_b64 s[4:5], s[8:9], 12
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_lshr_b64 s[0:1], s[0:1], 12
; GFX9-NEXT:    s_mul_i32 s9, s3, 0x10010011
; GFX9-NEXT:    s_mul_hi_u32 s10, s2, 0x10010011
; GFX9-NEXT:    s_mul_hi_u32 s8, s3, 0x10010011
; GFX9-NEXT:    s_add_u32 s9, s9, s10
; GFX9-NEXT:    s_mul_i32 s5, s2, 0x100100
; GFX9-NEXT:    s_addc_u32 s8, s8, 0
; GFX9-NEXT:    s_mul_hi_u32 s4, s2, 0x100100
; GFX9-NEXT:    s_add_u32 s5, s5, s9
; GFX9-NEXT:    s_addc_u32 s4, s4, 0
; GFX9-NEXT:    s_add_u32 s4, s8, s4
; GFX9-NEXT:    s_addc_u32 s5, 0, 0
; GFX9-NEXT:    s_mul_i32 s9, s3, 0x100100
; GFX9-NEXT:    s_mul_hi_u32 s8, s3, 0x100100
...
; GFX9-NEXT:    s_lshr_b64 s[2:3], s[2:3], 11
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    v_mov_b32_e32 v2, s2
; GFX9-NEXT:    v_mov_b32_e32 v3, s3
...
; CHECK-LABEL: define amdgpu_kernel void @udiv_v2i64_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]], <2 x i64> [[Y:%.*]]) {
...
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_add_i32 s4, s12, 12
; GFX6-NEXT:    s_add_i32 s6, s14, 12
...
; GFX9-NEXT:    v_mov_b32_e32 v4, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_add_i32 s2, s12, 12
; GFX9-NEXT:    s_add_i32 s4, s14, 12
...
; CHECK-LABEL: define amdgpu_kernel void @urem_i64_oddk_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]]) {
...
; GFX9-NEXT:    v_mov_b32_e32 v2, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mul_i32 s7, s3, 0xf6841139
; GFX9-NEXT:    s_mul_hi_u32 s8, s2, 0xf6841139
; GFX9-NEXT:    s_mul_hi_u32 s6, s3, 0xf6841139
; GFX9-NEXT:    s_add_u32 s7, s7, s8
; GFX9-NEXT:    s_mul_i32 s5, s2, 0xe3e10011
; GFX9-NEXT:    s_addc_u32 s6, s6, 0
; GFX9-NEXT:    s_mul_hi_u32 s4, s2, 0xe3e10011
; GFX9-NEXT:    s_add_u32 s5, s5, s7
; GFX9-NEXT:    s_addc_u32 s4, s4, 0
; GFX9-NEXT:    s_add_u32 s4, s6, s4
; GFX9-NEXT:    s_addc_u32 s5, 0, 0
; GFX9-NEXT:    s_mul_i32 s7, s3, 0xe3e10011
; GFX9-NEXT:    s_mul_hi_u32 s6, s3, 0xe3e10011
; GFX9-NEXT:    s_add_u32 s4, s7, s4
; GFX9-NEXT:    s_addc_u32 s4, s6, s5
; GFX9-NEXT:    s_lshr_b32 s4, s4, 8
; GFX9-NEXT:    s_mul_i32 s5, s4, 0x11f
; GFX9-NEXT:    s_mul_hi_u32 s6, s4, 0x9761f7c9
; GFX9-NEXT:    s_add_i32 s6, s6, s5
; GFX9-NEXT:    s_mul_i32 s4, s4, 0x9761f7c9
; GFX9-NEXT:    s_sub_u32 s2, s2, s4
; GFX9-NEXT:    s_subb_u32 s3, s3, s6
; GFX9-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NEXT:    global_store_dwordx2 v2, v[0:1], s[0:1]
; GFX9-NEXT:    s_endpgm
...
; CHECK-LABEL: define amdgpu_kernel void @urem_i64_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @urem_i64_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]], i64 [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl i64 4096, [[Y]]
...
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_mov_b32 s5, s1
; GFX6-NEXT:    s_lshl_b64 s[0:1], 0x1000, s8
...
; GFX9-NEXT:    v_mov_b32_e32 v2, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_lshl_b64 s[4:5], 0x1000, s6
; GFX9-NEXT:    s_add_u32 s4, s4, -1
; GFX9-NEXT:    s_addc_u32 s5, s5, -1
...
; CHECK-LABEL: define amdgpu_kernel void @urem_v2i64_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i64> [[X]], i64 0
...
; GFX6-NEXT:    s_and_b32 s1, s2, 0xfff
; GFX6-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_and_b32 s0, s0, 0xfff
; GFX9-NEXT:    s_and_b32 s1, s2, 0xfff
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
...
; CHECK-LABEL: define amdgpu_kernel void @urem_v2i64_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]], <2 x i64> [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl <2 x i64> splat (i64 4096), [[Y]]
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i64> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <2 x i64> [[SHL_Y]], i64 0
...
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_lshl_b64 s[4:5], 0x1000, s14
; GFX6-NEXT:    s_lshl_b64 s[6:7], 0x1000, s12
; GFX6-NEXT:    s_add_u32 s6, s6, -1
; GFX6-NEXT:    s_addc_u32 s7, s7, -1
...
; GFX9-NEXT:    v_mov_b32_e32 v4, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_lshl_b64 s[2:3], 0x1000, s14
; GFX9-NEXT:    s_lshl_b64 s[4:5], 0x1000, s12
; GFX9-NEXT:    s_add_u32 s4, s4, -1
; GFX9-NEXT:    s_addc_u32 s5, s5, -1
; GFX9-NEXT:    s_and_b64 s[4:5], s[8:9], s[4:5]
; GFX9-NEXT:    s_add_u32 s2, s2, -1
; GFX9-NEXT:    s_addc_u32 s3, s3, -1
; GFX9-NEXT:    s_and_b64 s[2:3], s[10:11], s[2:3]
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_i64_oddk_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]]) {
...
; GFX9-NEXT:    v_mov_b32_e32 v2, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mul_hi_u32 s4, s2, 0x6ca94220
; GFX9-NEXT:    s_mul_i32 s5, s2, 0x6ca94220
; GFX9-NEXT:    s_mul_i32 s7, s3, 0xfd81e19
; GFX9-NEXT:    s_mul_hi_u32 s2, s2, 0xfd81e19
...
; GFX9-NEXT:    s_add_u32 s2, s6, s2
; GFX9-NEXT:    s_addc_u32 s4, 0, 0
; GFX9-NEXT:    s_mul_i32 s6, s3, 0x6ca94220
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_i64_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_i64_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]], i64 [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl i64 4096, [[Y]]
...
; GFX6-NEXT:    s_mul_i32 s15, s1, s13
...
; GFX6-NEXT:    v_mul_hi_u32 v1, s0, v1
; GFX6-NEXT:    s_addc_u32 s12, s12, s15
; GFX6-NEXT:    s_mul_i32 s14, s0, s13
; GFX6-NEXT:    s_mul_i32 s0, s0, s12
; GFX6-NEXT:    v_readfirstlane_b32 s15, v1
; GFX6-NEXT:    s_add_i32 s0, s15, s0
...
; GFX6-NEXT:    v_mul_hi_u32 v3, s13, v1
; GFX6-NEXT:    s_mul_i32 s15, s13, s0
; GFX6-NEXT:    s_mul_i32 s14, s12, s14
; GFX6-NEXT:    v_readfirstlane_b32 s17, v0
; GFX6-NEXT:    v_mul_hi_u32 v0, s12, v1
...
; GFX6-NEXT:    s_add_u32 s14, s15, s14
; GFX6-NEXT:    s_addc_u32 s1, s16, s1
...
; GFX9-NEXT:    s_addc_u32 s13, s13, s16
...
; GFX9-NEXT:    s_mul_hi_u32 s14, s3, s11
; GFX9-NEXT:    s_mul_i32 s11, s3, s11
; GFX9-NEXT:    s_add_u32 s11, s13, s11
; GFX9-NEXT:    s_addc_u32 s11, s12, s14
; GFX9-NEXT:    s_mul_hi_u32 s12, s3, s10
; GFX9-NEXT:    s_addc_u32 s12, s12, 0
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_v2i64_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i64> [[X]], i64 0
...
; CHECK-LABEL: define amdgpu_kernel void @ssdiv_v2i64_mixed_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i64> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = sdiv i64 [[TMP1]], 4096
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <2 x i64> poison, i64 [[TMP2]], i64 0
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mul_hi_u32 v3, s10, v2
; GFX6-NEXT:    v_mul_hi_u32 v4, s11, v2
; GFX6-NEXT:    v_mul_hi_u32 v1, s10, v0
; GFX6-NEXT:    s_mul_i32 s7, s11, 0x8008009
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, s7, v3
; GFX6-NEXT:    s_mul_i32 s6, s10, 0x80080080
; GFX6-NEXT:    v_addc_u32_e32 v4, vcc, 0, v4, vcc
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, s6, v3
...
; GFX6-NEXT:    v_addc_u32_e64 v3, s[6:7], 0, 0, vcc
; GFX6-NEXT:    s_addc_u32 s5, s9, 0
; GFX6-NEXT:    s_ashr_i32 s7, s11, 31
; GFX6-NEXT:    v_mul_hi_u32 v0, s11, v0
; GFX6-NEXT:    v_mul_hi_u32 v2, s7, v2
; GFX6-NEXT:    s_mul_i32 s6, s11, 0x80080080
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, s6, v1
; GFX6-NEXT:    s_mul_i32 s6, s7, 0x80080080
; GFX6-NEXT:    v_addc_u32_e32 v0, vcc, v0, v3, vcc
; GFX6-NEXT:    v_add_i32_e32 v2, vcc, s6, v2
; GFX6-NEXT:    s_mul_i32 s6, s7, 0x8008009
; GFX6-NEXT:    v_add_i32_e32 v2, vcc, s6, v2
; GFX6-NEXT:    v_mov_b32_e32 v3, s6
; GFX6-NEXT:    v_mov_b32_e32 v4, s11
; GFX6-NEXT:    v_subrev_i32_e32 v3, vcc, s10, v3
; GFX6-NEXT:    v_subb_u32_e32 v2, vcc, v2, v4, vcc
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, v1, v3
; GFX6-NEXT:    v_addc_u32_e32 v2, vcc, v0, v2, vcc
; GFX6-NEXT:    v_mov_b32_e32 v3, s11
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, s10, v1
...
; GFX9-NEXT:    s_addc_u32 s1, s1, 0
; GFX9-NEXT:    s_ashr_i64 s[0:1], s[0:1], 12
; GFX9-NEXT:    s_mul_i32 s9, s3, 0x8008009
; GFX9-NEXT:    s_mul_hi_u32 s10, s2, 0x8008009
; GFX9-NEXT:    s_mul_hi_u32 s4, s3, 0x8008009
; GFX9-NEXT:    s_add_u32 s9, s9, s10
; GFX9-NEXT:    s_mul_i32 s8, s2, 0x80080080
; GFX9-NEXT:    s_addc_u32 s4, s4, 0
; GFX9-NEXT:    s_mul_hi_u32 s5, s2, 0x80080080
; GFX9-NEXT:    s_add_u32 s8, s8, s9
; GFX9-NEXT:    s_addc_u32 s5, s5, 0
; GFX9-NEXT:    s_add_u32 s4, s4, s5
; GFX9-NEXT:    s_addc_u32 s5, 0, 0
; GFX9-NEXT:    s_mul_i32 s9, s3, 0x80080080
; GFX9-NEXT:    s_mul_hi_u32 s8, s3, 0x80080080
; GFX9-NEXT:    s_add_u32 s4, s9, s4
; GFX9-NEXT:    s_addc_u32 s5, s8, s5
...
; GFX9-NEXT:    s_sub_u32 s8, s8, s2
; GFX9-NEXT:    s_subb_u32 s9, s9, s3
; GFX9-NEXT:    s_add_u32 s4, s4, s8
; GFX9-NEXT:    s_addc_u32 s5, s5, s9
; GFX9-NEXT:    s_add_u32 s2, s4, s2
; GFX9-NEXT:    s_addc_u32 s3, s5, s3
; GFX9-NEXT:    s_ashr_i64 s[4:5], s[2:3], 11
; GFX9-NEXT:    s_lshr_b32 s2, s3, 31
; GFX9-NEXT:    s_add_u32 s2, s4, s2
; GFX9-NEXT:    s_addc_u32 s3, s5, 0
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
...
; CHECK-LABEL: define amdgpu_kernel void @sdiv_v2i64_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]], <2 x i64> [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl <2 x i64> splat (i64 4096), [[Y]]
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i64> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <2 x i64> [[SHL_Y]], i64 0
...
; GFX6-NEXT:    v_mul_hi_u32 v1, s12, v1
; GFX6-NEXT:    s_addc_u32 s14, s14, s17
; GFX6-NEXT:    s_mul_i32 s16, s12, s15
; GFX6-NEXT:    s_mul_i32 s12, s12, s14
; GFX6-NEXT:    v_readfirstlane_b32 s17, v1
; GFX6-NEXT:    s_add_i32 s12, s17, s12
; GFX6-NEXT:    s_mul_i32 s13, s13, s15
; GFX6-NEXT:    v_mov_b32_e32 v0, s16
; GFX6-NEXT:    s_add_i32 s12, s12, s13
; GFX6-NEXT:    v_mul_hi_u32 v2, s14, v0
; GFX6-NEXT:    v_mov_b32_e32 v1, s12
; GFX6-NEXT:    v_mul_hi_u32 v0, s15, v0
; GFX6-NEXT:    v_mul_hi_u32 v3, s15, v1
; GFX6-NEXT:    s_mul_i32 s17, s15, s12
; GFX6-NEXT:    s_mul_i32 s16, s14, s16
; GFX6-NEXT:    v_readfirstlane_b32 s19, v0
; GFX6-NEXT:    v_mul_hi_u32 v0, s14, v1
...
; GFX6-NEXT:    s_add_u32 s16, s17, s16
; GFX6-NEXT:    s_addc_u32 s13, s18, s13
; GFX6-NEXT:    v_readfirstlane_b32 s16, v0
; GFX6-NEXT:    s_addc_u32 s16, s16, 0
...
; GFX6-NEXT:    s_mul_i32 s1, s2, s13
; GFX6-NEXT:    v_readfirstlane_b32 s16, v2
; GFX6-NEXT:    s_mul_i32 s0, s3, s12
; GFX6-NEXT:    s_add_i32 s1, s16, s1
; GFX6-NEXT:    s_add_i32 s16, s1, s0
; GFX6-NEXT:    s_mul_i32 s17, s2, s12
; GFX6-NEXT:    v_mul_hi_u32 v2, v0, s16
; GFX6-NEXT:    v_mul_hi_u32 v0, v0, s17
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX6-NEXT:    s_mul_i32 s4, s12, s16
...
; GFX6-NEXT:    s_mul_i32 s17, s13, s17
; GFX6-NEXT:    v_readfirstlane_b32 s18, v0
...
; GFX6-NEXT:    s_mul_i32 s16, s13, s16
; GFX6-NEXT:    s_add_u32 s4, s4, s16
; GFX6-NEXT:    s_addc_u32 s5, 0, s5
; GFX6-NEXT:    s_add_u32 s4, s12, s4
; GFX6-NEXT:    v_mov_b32_e32 v1, s4
; GFX6-NEXT:    v_mul_hi_u32 v1, s2, v1
; GFX6-NEXT:    s_addc_u32 s5, s13, s5
; GFX6-NEXT:    s_mul_i32 s12, s2, s4
; GFX6-NEXT:    s_mul_i32 s2, s2, s5
; GFX6-NEXT:    v_readfirstlane_b32 s13, v1
; GFX6-NEXT:    s_add_i32 s2, s13, s2
; GFX6-NEXT:    s_mul_i32 s3, s3, s4
; GFX6-NEXT:    v_mov_b32_e32 v0, s12
; GFX6-NEXT:    s_add_i32 s2, s2, s3
; GFX6-NEXT:    v_mul_hi_u32 v2, s5, v0
; GFX6-NEXT:    v_mov_b32_e32 v1, s2
; GFX6-NEXT:    v_mul_hi_u32 v0, s4, v0
; GFX6-NEXT:    v_mul_hi_u32 v3, s4, v1
; GFX6-NEXT:    s_mul_i32 s13, s4, s2
; GFX6-NEXT:    s_mul_i32 s12, s5, s12
; GFX6-NEXT:    v_readfirstlane_b32 s17, v0
; GFX6-NEXT:    v_mul_hi_u32 v0, s5, v1
; GFX6-NEXT:    v_readfirstlane_b32 s16, v3
; GFX6-NEXT:    s_add_u32 s13, s17, s13
; GFX6-NEXT:    s_addc_u32 s16, 0, s16
; GFX6-NEXT:    v_readfirstlane_b32 s3, v2
; GFX6-NEXT:    s_add_u32 s12, s13, s12
; GFX6-NEXT:    s_addc_u32 s3, s16, s3
; GFX6-NEXT:    v_readfirstlane_b32 s12, v0
; GFX6-NEXT:    s_addc_u32 s12, s12, 0
; GFX6-NEXT:    s_mul_i32 s2, s5, s2
; GFX6-NEXT:    s_add_u32 s2, s3, s2
; GFX6-NEXT:    s_addc_u32 s3, 0, s12
; GFX6-NEXT:    s_add_u32 s12, s4, s2
; GFX6-NEXT:    s_addc_u32 s13, s5, s3
...
; GFX9-NEXT:    s_mul_i32 s21, s15, s16
...
; GFX9-NEXT:    s_addc_u32 s18, s18, 0
...
; GFX9-NEXT:    s_mul_i32 s16, s12, s15
; GFX9-NEXT:    s_mul_i32 s19, s12, s14
; GFX9-NEXT:    s_mul_hi_u32 s12, s12, s15
; GFX9-NEXT:    s_add_i32 s12, s12, s19
; GFX9-NEXT:    s_mul_i32 s13, s13, s15
; GFX9-NEXT:    s_add_i32 s12, s12, s13
; GFX9-NEXT:    s_mul_hi_u32 s17, s14, s16
; GFX9-NEXT:    s_mul_i32 s18, s14, s16
; GFX9-NEXT:    s_mul_i32 s19, s15, s12
; GFX9-NEXT:    s_mul_hi_u32 s16, s15, s16
; GFX9-NEXT:    s_mul_hi_u32 s13, s15, s12
; GFX9-NEXT:    s_add_u32 s16, s16, s19
; GFX9-NEXT:    s_addc_u32 s13, 0, s13
; GFX9-NEXT:    s_add_u32 s16, s16, s18
; GFX9-NEXT:    s_addc_u32 s13, s13, s17
; GFX9-NEXT:    s_mul_hi_u32 s16, s14, s12
; GFX9-NEXT:    s_addc_u32 s16, s16, 0
; GFX9-NEXT:    s_mul_i32 s12, s14, s12
; GFX9-NEXT:    s_add_u32 s12, s13, s12
; GFX9-NEXT:    s_addc_u32 s13, 0, s16
...
; GFX9-NEXT:    s_mul_hi_u32 s18, s9, s15
; GFX9-NEXT:    s_mul_i32 s15, s9, s15
; GFX9-NEXT:    s_add_u32 s15, s17, s15
; GFX9-NEXT:    s_addc_u32 s15, s16, s18
; GFX9-NEXT:    s_mul_hi_u32 s16, s9, s14
; GFX9-NEXT:    s_addc_u32 s16, s16, 0
...
; GFX9-NEXT:    s_mul_hi_u32 s18, s15, s17
; GFX9-NEXT:    s_mul_i32 s17, s15, s17
; GFX9-NEXT:    s_add_u32 s16, s16, s17
; GFX9-NEXT:    s_addc_u32 s9, s9, s18
; GFX9-NEXT:    s_mul_hi_u32 s16, s15, s14
; GFX9-NEXT:    s_addc_u32 s16, s16, 0
...
; GFX9-NEXT:    s_mul_i32 s17, s4, s9
; GFX9-NEXT:    s_mul_hi_u32 s4, s4, s8
; GFX9-NEXT:    s_add_i32 s4, s4, s17
; GFX9-NEXT:    s_mul_i32 s5, s5, s8
; GFX9-NEXT:    s_add_i32 s4, s4, s5
; GFX9-NEXT:    s_mul_hi_u32 s15, s9, s14
; GFX9-NEXT:    s_mul_i32 s16, s9, s14
; GFX9-NEXT:    s_mul_i32 s17, s8, s4
; GFX9-NEXT:    s_mul_hi_u32 s14, s8, s14
; GFX9-NEXT:    s_mul_hi_u32 s5, s8, s4
; GFX9-NEXT:    s_add_u32 s14, s14, s17
; GFX9-NEXT:    s_addc_u32 s5, 0, s5
; GFX9-NEXT:    s_add_u32 s14, s14, s16
; GFX9-NEXT:    s_addc_u32 s5, s5, s15
; GFX9-NEXT:    s_mul_hi_u32 s14, s9, s4
; GFX9-NEXT:    s_addc_u32 s14, s14, 0
; GFX9-NEXT:    s_mul_i32 s4, s9, s4
; GFX9-NEXT:    s_add_u32 s4, s5, s4
; GFX9-NEXT:    s_addc_u32 s5, 0, s14
...
; GFX9-NEXT:    s_addc_u32 s10, s10, s16
; GFX9-NEXT:    s_mul_hi_u32 s11, s9, s15
...
; CHECK-LABEL: define amdgpu_kernel void @srem_i64_oddk_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]]) {
...
; GFX9-NEXT:    s_add_u32 s4, s6, s4
; GFX9-NEXT:    s_addc_u32 s5, 0, 0
; GFX9-NEXT:    s_mul_i32 s7, s3, 0x6ca94220
; GFX9-NEXT:    s_mul_hi_u32 s6, s3, 0x6ca94220
; GFX9-NEXT:    s_add_u32 s4, s7, s4
; GFX9-NEXT:    s_addc_u32 s5, s6, s5
...
; GFX9-NEXT:    s_add_i32 s6, s6, s5
; GFX9-NEXT:    s_mul_i32 s4, s4, 0x12d8fb
; GFX9-NEXT:    s_sub_u32 s2, s2, s4
; GFX9-NEXT:    s_subb_u32 s3, s3, s6
; GFX9-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NEXT:    v_mov_b32_e32 v1, s3
...
; CHECK-LABEL: define amdgpu_kernel void @srem_i64_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]]) {
...
; CHECK-LABEL: define amdgpu_kernel void @srem_i64_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]], i64 [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl i64 4096, [[Y]]
...
; GFX6-NEXT:    v_readfirstlane_b32 s11, v0
; GFX6-NEXT:    s_mul_i32 s12, s0, s10
; GFX6-NEXT:    v_readfirstlane_b32 s15, v2
; GFX6-NEXT:    s_mul_i32 s13, s1, s11
; GFX6-NEXT:    s_mul_i32 s14, s0, s11
; GFX6-NEXT:    s_add_i32 s12, s15, s12
...
; GFX6-NEXT:    s_mul_i32 s15, s11, s12
; GFX6-NEXT:    s_add_u32 s13, s13, s15
; GFX6-NEXT:    v_readfirstlane_b32 s15, v0
; GFX6-NEXT:    v_mul_hi_u32 v0, v1, s12
; GFX6-NEXT:    s_mul_i32 s14, s10, s14
...
; GFX6-NEXT:    v_readfirstlane_b32 s14, v0
; GFX6-NEXT:    s_addc_u32 s14, s14, 0
; GFX6-NEXT:    s_mul_i32 s12, s10, s12
; GFX6-NEXT:    s_add_u32 s12, s13, s12
; GFX6-NEXT:    s_addc_u32 s13, 0, s14
; GFX6-NEXT:    s_add_u32 s11, s11, s12
; GFX6-NEXT:    v_mov_b32_e32 v1, s11
; GFX6-NEXT:    v_mul_hi_u32 v1, s0, v1
; GFX6-NEXT:    s_addc_u32 s10, s10, s13
; GFX6-NEXT:    s_mul_i32 s12, s0, s11
; GFX6-NEXT:    s_mul_i32 s0, s0, s10
; GFX6-NEXT:    v_readfirstlane_b32 s13, v1
; GFX6-NEXT:    s_add_i32 s0, s13, s0
...
; GFX9-NEXT:    s_mul_hi_u32 s14, s8, s13
; GFX9-NEXT:    s_mul_i32 s13, s8, s13
; GFX9-NEXT:    s_add_u32 s12, s12, s13
; GFX9-NEXT:    s_addc_u32 s11, s11, s14
...
; GFX9-NEXT:    s_mul_i32 s10, s4, s9
; GFX9-NEXT:    s_mul_i32 s13, s4, s8
; GFX9-NEXT:    s_mul_hi_u32 s4, s4, s9
; GFX9-NEXT:    s_add_i32 s4, s4, s13
; GFX9-NEXT:    s_mul_i32 s5, s5, s9
; GFX9-NEXT:    s_add_i32 s4, s4, s5
; GFX9-NEXT:    s_mul_hi_u32 s11, s8, s10
; GFX9-NEXT:    s_mul_i32 s12, s8, s10
; GFX9-NEXT:    s_mul_i32 s13, s9, s4
; GFX9-NEXT:    s_mul_hi_u32 s10, s9, s10
; GFX9-NEXT:    s_mul_hi_u32 s5, s9, s4
; GFX9-NEXT:    s_add_u32 s10, s10, s13
; GFX9-NEXT:    s_addc_u32 s5, 0, s5
; GFX9-NEXT:    s_add_u32 s10, s10, s12
; GFX9-NEXT:    s_addc_u32 s5, s5, s11
; GFX9-NEXT:    s_mul_hi_u32 s10, s8, s4
; GFX9-NEXT:    s_addc_u32 s10, s10, 0
; GFX9-NEXT:    s_mul_i32 s4, s8, s4
; GFX9-NEXT:    s_add_u32 s4, s5, s4
; GFX9-NEXT:    s_addc_u32 s5, 0, s10
...
; GFX9-NEXT:    s_addc_u32 s9, s10, s12
...
; CHECK-LABEL: define amdgpu_kernel void @srem_v2i64_pow2k_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i64> [[X]], i64 0
...
; CHECK-LABEL: define amdgpu_kernel void @srem_v2i64_pow2_shl_denom(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]], <2 x i64> [[Y:%.*]]) {
; CHECK-NEXT:    [[SHL_Y:%.*]] = shl <2 x i64> splat (i64 4096), [[Y]]
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i64> [[X]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <2 x i64> [[SHL_Y]], i64 0
...
; GFX6-NEXT:    s_add_u32 s13, s13, s14
; GFX6-NEXT:    v_mov_b32_e32 v1, s13
; GFX6-NEXT:    v_mul_hi_u32 v1, s6, v1
; GFX6-NEXT:    s_addc_u32 s12, s12, s15
; GFX6-NEXT:    s_mul_i32 s14, s6, s13
; GFX6-NEXT:    s_mul_i32 s6, s6, s12
; GFX6-NEXT:    v_readfirstlane_b32 s15, v1
; GFX6-NEXT:    s_add_i32 s6, s15, s6
; GFX6-NEXT:    s_mul_i32 s7, s7, s13
; GFX6-NEXT:    v_mov_b32_e32 v0, s14
; GFX6-NEXT:    s_add_i32 s6, s6, s7
; GFX6-NEXT:    v_mul_hi_u32 v2, s12, v0
; GFX6-NEXT:    v_mov_b32_e32 v1, s6
; GFX6-NEXT:    v_mul_hi_u32 v0, s13, v0
; GFX6-NEXT:    v_mul_hi_u32 v3, s13, v1
...
; GFX6-NEXT:    v_readfirstlane_b32 s7, v2
; GFX6-NEXT:    s_add_u32 s14, s15, s14
; GFX6-NEXT:    s_addc_u32 s7, s16, s7
; GFX6-NEXT:    v_readfirstlane_b32 s14, v0
; GFX6-NEXT:    s_addc_u32 s14, s14, 0
...
; GFX6-NEXT:    v_readfirstlane_b32 s8, v0
; GFX6-NEXT:    s_mul_i32 s1, s2, s9
; GFX6-NEXT:    v_readfirstlane_b32 s12, v2
; GFX6-NEXT:    s_mul_i32 s0, s3, s8
; GFX6-NEXT:    s_add_i32 s1, s12, s1
; GFX6-NEXT:    s_add_i32 s12, s1, s0
; GFX6-NEXT:    s_mul_i32 s13, s2, s8
...
; GFX6-NEXT:    v_mul_hi_u32 v1, v1, s12
...
; GFX6-NEXT:    v_mov_b32_e32 v1, s4
; GFX6-NEXT:    v_mul_hi_u32 v1, s2, v1
; GFX6-NEXT:    s_addc_u32 s5, s9, s5
; GFX6-NEXT:    s_mul_i32 s8, s2, s4
; GFX6-NEXT:    s_mul_i32 s2, s2, s5
; GFX6-NEXT:    v_readfirstlane_b32 s9, v1
; GFX6-NEXT:    s_add_i32 s2, s9, s2
; GFX6-NEXT:    s_mul_i32 s3, s3, s4
...
; GFX6-NEXT:    v_mul_hi_u32 v0, s4, v0
; GFX6-NEXT:    v_mul_hi_u32 v3, s4, v1
; GFX6-NEXT:    s_mul_i32 s9, s4, s2
; GFX6-NEXT:    s_mul_i32 s8, s5, s8
; GFX6-NEXT:    v_readfirstlane_b32 s13, v0
; GFX6-NEXT:    v_mul_hi_u32 v0, s5, v1
...
; GFX6-NEXT:    v_readfirstlane_b32 s3, v2
; GFX6-NEXT:    s_add_u32 s8, s9, s8
; GFX6-NEXT:    s_addc_u32 s3, s12, s3
; GFX6-NEXT:    v_readfirstlane_b32 s8, v0
; GFX6-NEXT:    s_addc_u32 s8, s8, 0
; GFX6-NEXT:    s_mul_i32 s2, s5, s2
; GFX6-NEXT:    s_add_u32 s2, s3, s2
; GFX6-NEXT:    s_addc_u32 s3, 0, s8
; GFX6-NEXT:    s_add_u32 s12, s4, s2
; GFX6-NEXT:    s_addc_u32 s13, s5, s3
; GFX6-NEXT:    s_ashr_i32 s4, s11, 31
; GFX6-NEXT:    s_add_u32 s2, s10, s4
...
; GFX9-NEXT:    s_mul_i32 s19, s13, s14
...
; GFX9-NEXT:    s_mul_hi_u32 s16, s12, s14
; GFX9-NEXT:    s_addc_u32 s16, s16, 0
...
; GFX9-NEXT:    s_mul_i32 s14, s6, s13
; GFX9-NEXT:    s_mul_i32 s17, s6, s12
; GFX9-NEXT:    s_mul_hi_u32 s6, s6, s13
; GFX9-NEXT:    s_add_i32 s6, s6, s17
; GFX9-NEXT:    s_mul_i32 s7, s7, s13
; GFX9-NEXT:    s_add_i32 s6, s6, s7
; GFX9-NEXT:    s_mul_hi_u32 s15, s12, s14
; GFX9-NEXT:    s_mul_i32 s16, s12, s14
; GFX9-NEXT:    s_mul_i32 s17, s13, s6
; GFX9-NEXT:    s_mul_hi_u32 s14, s13, s14
; GFX9-NEXT:    s_mul_hi_u32 s7, s13, s6
; GFX9-NEXT:    s_add_u32 s14, s14, s17
; GFX9-NEXT:    s_addc_u32 s7, 0, s7
; GFX9-NEXT:    s_add_u32 s14, s14, s16
; GFX9-NEXT:    s_addc_u32 s7, s7, s15
; GFX9-NEXT:    s_mul_hi_u32 s14, s12, s6
; GFX9-NEXT:    s_addc_u32 s14, s14, 0
; GFX9-NEXT:    s_mul_i32 s6, s12, s6
; GFX9-NEXT:    s_add_u32 s6, s7, s6
; GFX9-NEXT:    s_addc_u32 s7, 0, s14
...
; GFX9-NEXT:    s_mul_hi_u32 s16, s9, s13
; GFX9-NEXT:    s_mul_i32 s13, s9, s13
; GFX9-NEXT:    s_add_u32 s13, s15, s13
; GFX9-NEXT:    s_addc_u32 s13, s14, s16
; GFX9-NEXT:    s_mul_hi_u32 s14, s9, s12
; GFX9-NEXT:    s_addc_u32 s14, s14, 0
...
; GFX9-NEXT:    s_mul_i32 s15, s9, s15
; GFX9-NEXT:    s_add_u32 s14, s14, s15
; GFX9-NEXT:    s_addc_u32 s7, s7, s16
; GFX9-NEXT:    s_mul_hi_u32 s14, s9, s8
; GFX9-NEXT:    s_addc_u32 s14, s14, 0
...
; GFX9-NEXT:    s_mul_i32 s8, s4, s6
; GFX9-NEXT:    s_mul_i32 s15, s4, s7
; GFX9-NEXT:    s_mul_hi_u32 s4, s4, s6
; GFX9-NEXT:    s_add_i32 s4, s4, s15
; GFX9-NEXT:    s_mul_i32 s5, s5, s6
; GFX9-NEXT:    s_add_i32 s4, s4, s5
; GFX9-NEXT:    s_mul_hi_u32 s9, s7, s8
; GFX9-NEXT:    s_mul_i32 s14, s7, s8
...
; GFX9-NEXT:    s_addc_u32 s5, s5, s9
; GFX9-NEXT:    s_mul_hi_u32 s8, s7, s4
; GFX9-NEXT:    s_addc_u32 s8, s8, 0
...
; GFX9-NEXT:    s_addc_u32 s8, s10, s14
; GFX9-NEXT:    s_mul_hi_u32 s10, s7, s9
; GFX9-NEXT:    s_addc_u32 s10, s10, 0
...
; CHECK-LABEL: define <2 x i32> @v_sdiv_i32_exact(
; CHECK-SAME: <2 x i32> [[NUM:%.*]]) {
...
; CHECK-LABEL: define <2 x i64> @v_sdiv_i64_exact(
; CHECK-SAME: <2 x i64> [[NUM:%.*]]) {
...
; CHECK-LABEL: define <2 x i32> @v_udiv_i32_exact(
; CHECK-SAME: <2 x i32> [[NUM:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i32> [[NUM]], i64 0
...
; CHECK-LABEL: define <2 x i64> @v_udiv_i64_exact(
; CHECK-SAME: <2 x i64> [[NUM:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <2 x i64> [[NUM]], i64 0
...
; GFX6-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_and_b32 s4, s3, 0xffffff
; GFX6-NEXT:    v_cvt_f32_u32_e32 v0, s4
; GFX6-NEXT:    s_sub_i32 s3, 0, s4
; GFX6-NEXT:    s_and_b32 s5, s2, 0xffffff
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    v_rcp_f32_e32 v0, v0
; GFX6-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX6-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GFX9-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_and_b32 s3, s3, 0xffffff
; GFX9-NEXT:    v_cvt_f32_u32_e32 v0, s3
; GFX9-NEXT:    s_sub_i32 s4, 0, s3
