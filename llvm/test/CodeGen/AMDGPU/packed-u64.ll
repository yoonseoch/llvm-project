...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[12:15], v[0:3], v[12:15]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[0:3], v[4:7], v[8:11]
; GFX1251-SDAG-NEXT:    s_clause 0x1
...
; GFX1251-SDAG-NEXT:    global_load_b128 v[0:3], v76, s[0:1] offset:48
...
; GFX1251-SDAG-NEXT:    global_load_b128 v[52:55], v76, s[0:1] offset:80
; GFX1251-SDAG-NEXT:    global_load_b128 v[60:63], v76, s[0:1] offset:32
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[40:43], v[40:43], v[68:71]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[36:39], v[36:39], v[64:67]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[32:35], v[32:35], v[68:71]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[28:31], v[28:31], v[64:67]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[24:27], v[24:27], v[68:71]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[20:23], v[20:23], v[64:67]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[16:19], v[16:19], v[68:71]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[12:15], v[12:15], v[64:67]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[8:11], v[8:11], v[68:71]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[4:7], v[4:7], v[64:67]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[0:3], v[0:3], v[68:71]
...
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[44:47], v[44:47], v[64:67]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x2
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[56:59], v[56:59], v[72:75]
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[64:67], v[48:51], v[68:71]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v48, s40 :: v_dual_mov_b32 v49, s41
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v50, s42 :: v_dual_mov_b32 v51, s43
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v68, s16 :: v_dual_mov_b32 v69, s17
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s18 :: v_dual_mov_b32 v71, s19
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x1
; GFX1251-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[52:55], v[52:55], v[48:51]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1251-SDAG-NEXT:    v_pk_add_nc_u64 v[48:51], v[60:63], v[68:71]
; GFX1251-SDAG-NEXT:    s_clause 0xf
...
; GFX1251-SDAG-NEXT:    global_store_b128 v76, v[52:55], s[0:1] offset:80
; GFX1251-SDAG-NEXT:    global_store_b128 v76, v[48:51], s[0:1] offset:32
; GFX1251-SDAG-NEXT:    global_store_b128 v76, v[0:3], s[0:1] offset:48
...
; GFX1251-GISEL-NEXT:    v_pk_add_nc_u64 v[32:35], v[32:35], v[72:75]
...
; GFX1251-GISEL-NEXT:    v_pk_add_nc_u64 v[28:31], v[28:31], v[64:67]
...
; GFX1251-GISEL-NEXT:    v_pk_add_nc_u64 v[24:27], v[24:27], v[68:71]
...
; GFX1251-GISEL-NEXT:    v_pk_add_nc_u64 v[20:23], v[20:23], v[64:67]
; GFX1251-GISEL-NEXT:    s_wait_kmcnt 0x0
...
; GFX1251-GISEL-NEXT:    v_pk_add_nc_u64 v[16:19], v[16:19], v[68:71]
...
; GFX1251-GISEL-NEXT:    v_pk_add_nc_u64 v[12:15], v[12:15], v[64:67]
...
; GFX1251-GISEL-NEXT:    v_pk_add_nc_u64 v[8:11], v[8:11], v[68:71]
...
; GFX1251-GISEL-NEXT:    v_pk_add_nc_u64 v[4:7], v[4:7], v[64:67]
...
; GFX1251-GISEL-NEXT:    v_pk_add_nc_u64 v[0:3], v[0:3], v[68:71]
...
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x1
; GFX1251-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[12:15], v[0:3], v[12:15]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[0:3], v[4:7], v[8:11]
; GFX1251-SDAG-NEXT:    s_clause 0x1
; GFX1251-SDAG-NEXT:    global_store_b128 v16, v[12:15], s[0:1]
; GFX1251-SDAG-NEXT:    global_store_b128 v16, v[0:3], s[0:1] offset:16
; GFX1251-SDAG-NEXT:    s_endpgm
...
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v74, s46 :: v_dual_mov_b32 v75, s47
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xf
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[40:43], v[40:43], v[68:71]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v68, s80 :: v_dual_mov_b32 v69, s81
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s82 :: v_dual_mov_b32 v71, s83
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xe
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[36:39], v[36:39], v[64:67]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v64, s76 :: v_dual_mov_b32 v65, s77
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v66, s78 :: v_dual_mov_b32 v67, s79
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xd
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[32:35], v[32:35], v[68:71]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v68, s56 :: v_dual_mov_b32 v69, s57
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s58 :: v_dual_mov_b32 v71, s59
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xc
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[28:31], v[28:31], v[64:67]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v64, s52 :: v_dual_mov_b32 v65, s53
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v66, s54 :: v_dual_mov_b32 v67, s55
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xb
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[24:27], v[24:27], v[68:71]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v68, s64 :: v_dual_mov_b32 v69, s65
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s66 :: v_dual_mov_b32 v71, s67
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xa
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[20:23], v[20:23], v[64:67]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v64, s60 :: v_dual_mov_b32 v65, s61
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v66, s62 :: v_dual_mov_b32 v67, s63
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x9
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[16:19], v[16:19], v[68:71]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v68, s12 :: v_dual_mov_b32 v69, s13
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s14 :: v_dual_mov_b32 v71, s15
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x8
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[12:15], v[12:15], v[64:67]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v64, s8 :: v_dual_mov_b32 v65, s9
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v66, s10 :: v_dual_mov_b32 v67, s11
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x7
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[8:11], v[8:11], v[68:71]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v68, s20 :: v_dual_mov_b32 v69, s21
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s22 :: v_dual_mov_b32 v71, s23
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x6
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[4:7], v[4:7], v[64:67]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v64, s36 :: v_dual_mov_b32 v65, s37
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v66, s38 :: v_dual_mov_b32 v67, s39
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x5
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[0:3], v[0:3], v[68:71]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v68, s48 :: v_dual_mov_b32 v69, s49
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s50 :: v_dual_mov_b32 v71, s51
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x4
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[44:47], v[44:47], v[64:67]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x2
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[56:59], v[56:59], v[72:75]
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[64:67], v[48:51], v[68:71]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v48, s40 :: v_dual_mov_b32 v49, s41
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v50, s42 :: v_dual_mov_b32 v51, s43
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v68, s16 :: v_dual_mov_b32 v69, s17
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s18 :: v_dual_mov_b32 v71, s19
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x1
; GFX1251-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[52:55], v[52:55], v[48:51]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1251-SDAG-NEXT:    v_pk_sub_nc_u64 v[48:51], v[60:63], v[68:71]
; GFX1251-SDAG-NEXT:    s_clause 0xf
; GFX1251-SDAG-NEXT:    global_store_b128 v76, v[56:59], s[0:1] offset:96
; GFX1251-SDAG-NEXT:    global_store_b128 v76, v[64:67], s[0:1] offset:112
; GFX1251-SDAG-NEXT:    global_store_b128 v76, v[44:47], s[0:1] offset:64
...
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[64:65], s[44:45]
; GFX1251-GISEL-NEXT:    s_wait_loadcnt 0xc
; GFX1251-GISEL-NEXT:    v_pk_sub_nc_u64 v[32:35], v[32:35], v[72:75]
; GFX1251-GISEL-NEXT:    v_pk_sub_nc_u64 v[36:39], v[36:39], v[68:71]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[70:71], s[50:51]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[68:69], s[48:49]
; GFX1251-GISEL-NEXT:    s_load_b512 s[36:51], s[4:5], 0x1e4 nv
; GFX1251-GISEL-NEXT:    s_wait_loadcnt 0xb
; GFX1251-GISEL-NEXT:    v_pk_sub_nc_u64 v[28:31], v[28:31], v[64:67]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[66:67], s[54:55]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[64:65], s[52:53]
; GFX1251-GISEL-NEXT:    s_wait_loadcnt 0xa
; GFX1251-GISEL-NEXT:    v_pk_sub_nc_u64 v[24:27], v[24:27], v[68:71]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[70:71], s[58:59]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[68:69], s[56:57]
; GFX1251-GISEL-NEXT:    s_wait_loadcnt 0x9
; GFX1251-GISEL-NEXT:    v_pk_sub_nc_u64 v[20:23], v[20:23], v[64:67]
; GFX1251-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[66:67], s[10:11]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[64:65], s[8:9]
; GFX1251-GISEL-NEXT:    s_wait_loadcnt 0x8
; GFX1251-GISEL-NEXT:    v_pk_sub_nc_u64 v[16:19], v[16:19], v[68:71]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[70:71], s[14:15]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[68:69], s[12:13]
; GFX1251-GISEL-NEXT:    s_wait_loadcnt 0x7
; GFX1251-GISEL-NEXT:    v_pk_sub_nc_u64 v[12:15], v[12:15], v[64:67]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[66:67], s[18:19]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[64:65], s[16:17]
; GFX1251-GISEL-NEXT:    s_wait_loadcnt 0x6
; GFX1251-GISEL-NEXT:    v_pk_sub_nc_u64 v[8:11], v[8:11], v[68:71]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[70:71], s[22:23]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[68:69], s[20:21]
; GFX1251-GISEL-NEXT:    s_wait_loadcnt 0x5
; GFX1251-GISEL-NEXT:    v_pk_sub_nc_u64 v[4:7], v[4:7], v[64:67]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[66:67], s[38:39]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[64:65], s[36:37]
; GFX1251-GISEL-NEXT:    s_wait_loadcnt 0x4
; GFX1251-GISEL-NEXT:    v_pk_sub_nc_u64 v[0:3], v[0:3], v[68:71]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[70:71], s[42:43]
; GFX1251-GISEL-NEXT:    v_mov_b64_e32 v[68:69], s[40:41]
; GFX1251-GISEL-NEXT:    s_wait_loadcnt 0x3
