...
; RUN: llc -global-isel=0 -verify-machineinstrs -mtriple=amdgpu9.08 < %s | FileCheck -enable-var-scope --check-prefixes=GCN,NOLIT-SRCC,GFX908,GFX908_A %s
; RUN: llc -global-isel=1 -verify-machineinstrs -mtriple=amdgpu9.08 < %s | FileCheck -enable-var-scope --check-prefixes=GFX908-GISEL,GFX908-GISEL-NOLIT-SRCC %s
; RUN: llc -global-isel=0 -verify-machineinstrs -mtriple=amdgpu9.08 -mattr=-mfma-inline-literal-bug < %s | FileCheck -enable-var-scope --check-prefixes=GCN,LIT-SRCC,GFX908,GFX908_A %s
; RUN: llc -global-isel=1 -verify-machineinstrs -mtriple=amdgpu9.08 -mattr=-mfma-inline-literal-bug < %s | FileCheck -enable-var-scope --check-prefixes=GFX908-GISEL,GFX908-GISEL-LIT-SRCC %s
; RUN: llc -global-isel=0 -verify-machineinstrs -mtriple=amdgpu9.0a < %s | FileCheck -enable-var-scope --check-prefixes=GCN,GFX90A,GFX908_A,GFX90A_42 %s
; RUN: llc -global-isel=1 -verify-machineinstrs -mtriple=amdgpu9.0a < %s | FileCheck -enable-var-scope --check-prefixes=GFX90A-GISEL %s
; RUN: llc -global-isel=0 -verify-machineinstrs -mtriple=amdgpu9.42 < %s | FileCheck -enable-var-scope --check-prefixes=GCN,GFX942,GFX90A_42 %s
; RUN: llc -global-isel=1 -verify-machineinstrs -mtriple=amdgpu9.42 < %s | FileCheck -enable-var-scope --check-prefixes=GFX942-GISEL %s
; RUN: llc -global-isel=0 -verify-machineinstrs -mtriple=amdgpu9.42 -amdgpu-mfma-vgpr-form < %s | FileCheck -enable-var-scope --check-prefix=GFX942-VGPR %s
; RUN: llc -global-isel=1 -verify-machineinstrs -mtriple=amdgpu9.42 -amdgpu-mfma-vgpr-form < %s | FileCheck -enable-var-scope --check-prefix=GFX942-VGPR-GISEL %s
...
; NOLIT-SRCC-NEXT:    global_store_dwordx4 v32, v[4:7], s[0:1] offset:16
; NOLIT-SRCC-NEXT:    s_endpgm
;
...
; LIT-SRCC-NEXT:    global_store_dwordx4 v32, v[4:7], s[0:1] offset:16
; LIT-SRCC-NEXT:    s_endpgm
;
