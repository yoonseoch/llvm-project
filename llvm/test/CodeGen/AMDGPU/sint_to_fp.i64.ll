...
; GFX6-NEXT:    s_mov_b32 s7, 0xf000
; GFX6-NEXT:    s_mov_b32 s6, 0
; GFX6-NEXT:    v_lshlrev_b32_e32 v9, 5, v0
; GFX6-NEXT:    v_mov_b32_e32 v10, 0
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_mov_b64 s[4:5], s[2:3]
; GFX6-NEXT:    buffer_load_dwordx4 v[5:8], v[9:10], s[4:7], 0 addr64 offset:16
; GFX6-NEXT:    buffer_load_dwordx4 v[1:4], v[9:10], s[4:7], 0 addr64
; GFX6-NEXT:    v_lshlrev_b32_e32 v9, 4, v0
; GFX6-NEXT:    s_mov_b64 s[2:3], s[6:7]
; GFX6-NEXT:    s_waitcnt vmcnt(1)
; GFX6-NEXT:    v_xor_b32_e32 v0, v7, v8
; GFX6-NEXT:    v_xor_b32_e32 v12, v5, v6
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    v_xor_b32_e32 v14, v3, v4
; GFX6-NEXT:    v_xor_b32_e32 v16, v1, v2
; GFX6-NEXT:    v_ffbh_i32_e32 v11, v8
; GFX6-NEXT:    v_ffbh_i32_e32 v13, v6
; GFX6-NEXT:    v_ffbh_i32_e32 v15, v4
; GFX6-NEXT:    v_ffbh_i32_e32 v17, v2
...
; GFX6-NEXT:    v_add_i32_e32 v11, vcc, -1, v11
...
; GFX6-NEXT:    v_min_u32_e32 v0, v11, v0
; GFX6-NEXT:    v_min_u32_e32 v11, v13, v12
...
; GFX6-NEXT:    v_lshl_b64 v[5:6], v[5:6], v11
; GFX6-NEXT:    v_lshl_b64 v[3:4], v[3:4], v12
; GFX6-NEXT:    v_lshl_b64 v[0:1], v[1:2], v13
; GFX6-NEXT:    v_min_u32_e32 v2, 1, v7
...
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, v2
; GFX6-NEXT:    v_cvt_f32_i32_e32 v2, v5
; GFX6-NEXT:    v_cvt_f32_i32_e32 v4, v3
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, v0
; GFX6-NEXT:    v_sub_i32_e32 v11, vcc, 32, v11
; GFX6-NEXT:    v_sub_i32_e32 v12, vcc, 32, v12
; GFX6-NEXT:    v_sub_i32_e32 v13, vcc, 32, v13
; GFX6-NEXT:    v_ldexp_f32_e32 v3, v1, v14
; GFX6-NEXT:    v_ldexp_f32_e32 v2, v2, v11
; GFX6-NEXT:    v_ldexp_f32_e32 v1, v4, v12
; GFX6-NEXT:    v_ldexp_f32_e32 v0, v0, v13
; GFX6-NEXT:    buffer_store_dwordx4 v[0:3], v[9:10], s[0:3], 0 addr64
; GFX6-NEXT:    s_endpgm
;
...
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, s2, v1
; GFX8-NEXT:    v_addc_u32_e32 v2, vcc, 0, v2, vcc
; GFX8-NEXT:    flat_load_dwordx4 v[5:8], v[1:2]
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, 16, v1
; GFX8-NEXT:    v_addc_u32_e32 v2, vcc, 0, v2, vcc
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_lshlrev_b32_e32 v0, 5, v8
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b128 v[4:7], v0, s[2:3] offset:16
; GFX11-NEXT:    global_load_b128 v[0:3], v0, s[2:3]
; GFX11-NEXT:    s_waitcnt vmcnt(1)
; GFX11-NEXT:    v_xor_b32_e32 v9, v6, v7
; GFX11-NEXT:    v_xor_b32_e32 v11, v4, v5
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_xor_b32_e32 v13, v2, v3
; GFX11-NEXT:    v_xor_b32_e32 v15, v0, v1
; GFX11-NEXT:    v_cls_i32_e32 v10, v7
; GFX11-NEXT:    v_cls_i32_e32 v12, v5
; GFX11-NEXT:    v_cls_i32_e32 v14, v3
; GFX11-NEXT:    v_cls_i32_e32 v16, v1
...
; GFX11-NEXT:    v_lshlrev_b64 v[0:1], v12, v[0:1]
...
; GFX11-NEXT:    v_cvt_f32_i32_e32 v1, v6
; GFX11-NEXT:    v_cvt_f32_i32_e32 v4, v4
; GFX11-NEXT:    v_cvt_f32_i32_e32 v6, v2
; GFX11-NEXT:    v_cvt_f32_i32_e32 v0, v0
; GFX11-NEXT:    v_lshlrev_b32_e32 v7, 4, v8
; GFX11-NEXT:    v_ldexp_f32 v3, v1, v9
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cvt_f16_f32_e32 v0.h, v0
; GFX11-TRUE16-NEXT:    v_cvt_f16_f32_e32 v0.l, v1
; GFX11-TRUE16-NEXT:    global_store_b32 v2, v0, s[4:5]
; GFX11-TRUE16-NEXT:    s_endpgm
;
...
; GFX6-NEXT:    v_min_u32_e32 v5, 1, v5
; GFX6-NEXT:    v_min_u32_e32 v0, 1, v0
; GFX6-NEXT:    v_or_b32_e32 v7, v8, v7
; GFX6-NEXT:    v_or_b32_e32 v3, v4, v3
; GFX6-NEXT:    v_or_b32_e32 v5, v6, v5
; GFX6-NEXT:    v_or_b32_e32 v0, v1, v0
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, v7
; GFX6-NEXT:    v_cvt_f32_i32_e32 v3, v3
; GFX6-NEXT:    v_cvt_f32_i32_e32 v4, v5
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, v0
; GFX6-NEXT:    v_sub_i32_e32 v12, vcc, 32, v12
; GFX6-NEXT:    v_sub_i32_e32 v11, vcc, 32, v11
; GFX6-NEXT:    v_sub_i32_e32 v2, vcc, 32, v13
; GFX6-NEXT:    v_ldexp_f32_e32 v1, v1, v14
; GFX6-NEXT:    v_ldexp_f32_e32 v3, v3, v12
; GFX6-NEXT:    v_ldexp_f32_e32 v4, v4, v11
; GFX6-NEXT:    v_ldexp_f32_e32 v0, v0, v2
; GFX6-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX6-NEXT:    v_cvt_f16_f32_e32 v2, v3
...
; GFX6-NEXT:    buffer_store_dwordx2 v[0:1], v[9:10], s[0:3], 0 addr64
; GFX6-NEXT:    s_endpgm
;
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v0, 5, v8
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    s_clause 0x1
; GFX11-TRUE16-NEXT:    global_load_b128 v[4:7], v0, s[2:3] offset:16
; GFX11-TRUE16-NEXT:    global_load_b128 v[0:3], v0, s[2:3]
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(1)
; GFX11-TRUE16-NEXT:    v_xor_b32_e32 v9, v6, v7
; GFX11-TRUE16-NEXT:    v_xor_b32_e32 v11, v4, v5
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    v_xor_b32_e32 v13, v2, v3
; GFX11-TRUE16-NEXT:    v_xor_b32_e32 v15, v0, v1
; GFX11-TRUE16-NEXT:    v_cls_i32_e32 v10, v7
; GFX11-TRUE16-NEXT:    v_cls_i32_e32 v12, v5
; GFX11-TRUE16-NEXT:    v_cls_i32_e32 v14, v3
; GFX11-TRUE16-NEXT:    v_cls_i32_e32 v16, v1
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_lshlrev_b64 v[6:7], v9, v[6:7]
; GFX11-TRUE16-NEXT:    v_lshlrev_b64 v[4:5], v10, v[4:5]
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_lshlrev_b64 v[2:3], v11, v[2:3]
; GFX11-TRUE16-NEXT:    v_lshlrev_b64 v[0:1], v12, v[0:1]
...
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v0, v1, v0
; GFX11-TRUE16-NEXT:    v_sub_nc_u32_e32 v1, 32, v12
; GFX11-TRUE16-NEXT:    v_cvt_f32_i32_e32 v3, v6
; GFX11-TRUE16-NEXT:    v_cvt_f32_i32_e32 v4, v4
; GFX11-TRUE16-NEXT:    v_cvt_f32_i32_e32 v2, v2
; GFX11-TRUE16-NEXT:    v_cvt_f32_i32_e32 v0, v0
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v6, 3, v8
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v3, v3, v9
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v4, v4, v10
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v2, v2, v11
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v5, v0, v1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_cvt_f16_f32_e32 v1.h, v3
; GFX11-TRUE16-NEXT:    v_cvt_f16_f32_e32 v1.l, v4
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_cvt_f16_f32_e32 v0.h, v2
; GFX11-TRUE16-NEXT:    v_cvt_f16_f32_e32 v0.l, v5
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v0, 5, v8
; GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FAKE16-NEXT:    s_clause 0x1
; GFX11-FAKE16-NEXT:    global_load_b128 v[4:7], v0, s[2:3] offset:16
; GFX11-FAKE16-NEXT:    global_load_b128 v[0:3], v0, s[2:3]
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(1)
; GFX11-FAKE16-NEXT:    v_xor_b32_e32 v9, v6, v7
; GFX11-FAKE16-NEXT:    v_xor_b32_e32 v11, v4, v5
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    v_xor_b32_e32 v13, v2, v3
; GFX11-FAKE16-NEXT:    v_xor_b32_e32 v15, v0, v1
; GFX11-FAKE16-NEXT:    v_cls_i32_e32 v10, v7
; GFX11-FAKE16-NEXT:    v_cls_i32_e32 v12, v5
; GFX11-FAKE16-NEXT:    v_cls_i32_e32 v14, v3
; GFX11-FAKE16-NEXT:    v_cls_i32_e32 v16, v1
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_lshlrev_b64 v[6:7], v9, v[6:7]
; GFX11-FAKE16-NEXT:    v_lshlrev_b64 v[4:5], v10, v[4:5]
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_lshlrev_b64 v[2:3], v11, v[2:3]
; GFX11-FAKE16-NEXT:    v_lshlrev_b64 v[0:1], v12, v[0:1]
...
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, v1, v0
; GFX11-FAKE16-NEXT:    v_sub_nc_u32_e32 v1, 32, v12
; GFX11-FAKE16-NEXT:    v_cvt_f32_i32_e32 v3, v6
; GFX11-FAKE16-NEXT:    v_cvt_f32_i32_e32 v4, v4
; GFX11-FAKE16-NEXT:    v_cvt_f32_i32_e32 v2, v2
; GFX11-FAKE16-NEXT:    v_cvt_f32_i32_e32 v0, v0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_ldexp_f32 v3, v3, v9
; GFX11-FAKE16-NEXT:    v_ldexp_f32 v4, v4, v10
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_ldexp_f32 v2, v2, v11
; GFX11-FAKE16-NEXT:    v_ldexp_f32 v0, v0, v1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_cvt_f16_f32_e32 v1, v3
; GFX11-FAKE16-NEXT:    v_cvt_f16_f32_e32 v3, v4
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_cvt_f16_f32_e32 v2, v2
; GFX11-FAKE16-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v4, 3, v8
