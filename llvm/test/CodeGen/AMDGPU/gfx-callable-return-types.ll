...
; RUN: llc -mtriple=amdgpu10.10--amdpal < %s | FileCheck --check-prefixes=GFX10PLUS,GFX10 %s
; RUN: llc -mtriple=amdgpu11.00--amdpal < %s | FileCheck --check-prefixes=GFX10PLUS,GFX11 %s
