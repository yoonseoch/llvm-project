...
; SI-NEXT:    buffer_load_dwordx4 v[7:10], off, s[8:11], 0 offset:16
; SI-NEXT:    buffer_load_dwordx4 v[0:3], off, s[8:11], 0
; SI-NEXT:    buffer_load_dwordx4 v[11:14], off, s[8:11], 0 offset:32
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_waitcnt vmcnt(2)
; SI-NEXT:    v_ashr_i64 v[9:10], v[9:10], v6
; SI-NEXT:    v_ashr_i64 v[7:8], v[7:8], v4
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_ashr_i64 v[2:3], v[2:3], v13
; SI-NEXT:    v_ashr_i64 v[0:1], v[0:1], v11
...
; VI-NEXT:    buffer_load_dwordx4 v[7:10], off, s[8:11], 0 offset:16
; VI-NEXT:    buffer_load_dwordx4 v[0:3], off, s[8:11], 0
; VI-NEXT:    buffer_load_dwordx4 v[11:14], off, s[8:11], 0 offset:32
; VI-NEXT:    s_mov_b32 s0, s4
; VI-NEXT:    s_mov_b32 s1, s5
; VI-NEXT:    s_waitcnt vmcnt(2)
; VI-NEXT:    v_ashrrev_i64 v[9:10], v6, v[9:10]
; VI-NEXT:    v_ashrrev_i64 v[7:8], v4, v[7:8]
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_ashrrev_i64 v[2:3], v13, v[2:3]
; VI-NEXT:    v_ashrrev_i64 v[0:1], v11, v[0:1]
; VI-NEXT:    buffer_store_dwordx4 v[7:10], off, s[0:3], 0 offset:16
