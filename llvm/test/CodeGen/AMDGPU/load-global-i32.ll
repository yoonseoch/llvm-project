...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00 < %s | FileCheck -check-prefix=SI-NOHSA %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu7.00--amdhsa < %s | FileCheck -check-prefix=GCNX3-HSA %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.02 -mattr=-flat-for-global < %s | FileCheck -check-prefix=GCNX3-NOHSA %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=r600 -mcpu=redwood < %s | FileCheck -check-prefix=EG %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.00--amdhsa < %s | FileCheck -check-prefix=GCN-HSA -check-prefix=GCN-GFX900-HSA %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.08--amdhsa < %s | FileCheck -check-prefix=GCN-HSA -check-prefix=GCN-GFX908-HSA %s
...
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[4:7], v[2:3]
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[0:3], v[0:1]
...
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    global_load_dwordx4 v[4:7], v10, s[2:3]
; GCN-HSA-NEXT:    global_load_dwordx4 v[0:3], v10, s[2:3] offset:16
; GCN-HSA-NEXT:    global_load_dwordx2 v[8:9], v10, s[2:3] offset:32
; GCN-HSA-NEXT:    s_waitcnt vmcnt(2)
; GCN-HSA-NEXT:    global_store_dwordx4 v10, v[4:7], s[0:1]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(2)
; GCN-HSA-NEXT:    global_store_dwordx4 v10, v[0:3], s[0:1] offset:16
; GCN-HSA-NEXT:    s_waitcnt vmcnt(2)
...
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    global_load_dwordx4 v[4:7], v11, s[2:3]
; GCN-HSA-NEXT:    global_load_dwordx4 v[0:3], v11, s[2:3] offset:16
; GCN-HSA-NEXT:    global_load_dwordx3 v[8:10], v11, s[2:3] offset:32
; GCN-HSA-NEXT:    s_waitcnt vmcnt(2)
; GCN-HSA-NEXT:    global_store_dwordx4 v11, v[4:7], s[0:1]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(2)
; GCN-HSA-NEXT:    global_store_dwordx4 v11, v[0:3], s[0:1] offset:16
; GCN-HSA-NEXT:    s_waitcnt vmcnt(2)
...
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v7, s3
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v6, s2
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[0:3], v[0:1]
...
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(3)
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[22:23], v[4:7]
; GCNX3-HSA-NEXT:    s_endpgm
;
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s9, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[8:11], 0 offset:32
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[8:11], 0 offset:48
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[8:11], 0
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[8:11], 0 offset:16
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s1
...
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[4:7], 0 offset:32
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(3)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[12:15], off, s[4:7], 0 offset:48
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(3)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(3)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[4:7], off, s[4:7], 0 offset:16
...
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    global_load_dwordx4 v[12:15], v16, s[2:3] offset:32
; GCN-HSA-NEXT:    global_load_dwordx4 v[8:11], v16, s[2:3] offset:48
; GCN-HSA-NEXT:    global_load_dwordx4 v[4:7], v16, s[2:3]
; GCN-HSA-NEXT:    global_load_dwordx4 v[0:3], v16, s[2:3] offset:16
; GCN-HSA-NEXT:    s_waitcnt vmcnt(3)
; GCN-HSA-NEXT:    global_store_dwordx4 v16, v[12:15], s[0:1] offset:32
; GCN-HSA-NEXT:    s_waitcnt vmcnt(3)
; GCN-HSA-NEXT:    global_store_dwordx4 v16, v[8:11], s[0:1] offset:48
; GCN-HSA-NEXT:    s_waitcnt vmcnt(3)
; GCN-HSA-NEXT:    global_store_dwordx4 v16, v[4:7], s[0:1]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(3)
; GCN-HSA-NEXT:    global_store_dwordx4 v16, v[0:3], s[0:1] offset:16
; GCN-HSA-NEXT:    s_endpgm
entry:
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s1
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(0)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v6
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v7
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, 0
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    global_load_dwordx4 v[4:7], v12, s[2:3]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v11, 31, v7
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v9, 31, v6
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, v6
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, v7
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v5
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v4
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, v4
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, v5
; GCN-HSA-NEXT:    global_store_dwordx4 v12, v[8:11], s[0:1] offset:16
...
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0 offset:48
; SI-NOHSA-NEXT:    s_waitcnt expcnt(0)
...
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[14:15], v[0:3]
; GCNX3-HSA-NEXT:    s_nop 0
...
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0 offset:48
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v8
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v9
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, v1
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    global_load_dwordx4 v[8:11], v1, s[2:3] offset:16
; GCN-HSA-NEXT:    global_load_dwordx4 v[4:7], v1, s[2:3]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(1)
...
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[8:11], 0
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[20:23], off, s[8:11], 0 offset:16
...
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v15, 31, v21
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v13, 31, v20
; SI-NOHSA-NEXT:    v_mov_b32_e32 v12, v20
; SI-NOHSA-NEXT:    v_mov_b32_e32 v14, v21
...
; GCNX3-HSA-NEXT:    s_add_u32 s2, s0, 16
; GCNX3-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v18, s3
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v17, s2
; GCNX3-HSA-NEXT:    s_add_u32 s2, s0, 48
; GCNX3-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v16, s1
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v15, s0
; GCNX3-HSA-NEXT:    s_add_u32 s0, s0, 32
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v20, s3
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v19, s2
; GCNX3-HSA-NEXT:    s_addc_u32 s1, s1, 0
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v22, s1
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v21, s0
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(1)
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v10, 31, v5
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v8, 31, v4
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v14, 31, v7
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v12, 31, v6
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v11, v6
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v13, v7
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v7, v4
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v9, v5
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[17:18], v[11:14]
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[15:16], v[7:10]
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(2)
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v6, 31, v1
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v10, 31, v3
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v8, 31, v2
...
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v3, v0
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v5, v1
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[19:20], v[7:10]
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[21:22], v[3:6]
; GCNX3-HSA-NEXT:    s_endpgm
;
...
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[8:11], 0
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[20:23], off, s[8:11], 0 offset:16
...
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v15, 31, v21
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v13, 31, v20
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v12, v20
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v14, v21
...
; GCN-HSA:       ; %bb.0:
; GCN-HSA-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; GCN-HSA-NEXT:    v_mov_b32_e32 v24, 0
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    global_load_dwordx4 v[4:7], v24, s[2:3]
; GCN-HSA-NEXT:    global_load_dwordx4 v[20:23], v24, s[2:3] offset:16
; GCN-HSA-NEXT:    s_waitcnt vmcnt(1)
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v5
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v19, 31, v23
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v17, 31, v22
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, v22
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, v23
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v4
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v11, 31, v7
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v9, 31, v6
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v15, 31, v21
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v13, 31, v20
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, v20
; GCN-HSA-NEXT:    v_mov_b32_e32 v14, v21
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, v6
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, v7
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, v4
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, v5
; GCN-HSA-NEXT:    global_store_dwordx4 v24, v[16:19], s[0:1] offset:48
; GCN-HSA-NEXT:    global_store_dwordx4 v24, v[12:15], s[0:1] offset:32
; GCN-HSA-NEXT:    global_store_dwordx4 v24, v[8:11], s[0:1] offset:16
; GCN-HSA-NEXT:    global_store_dwordx4 v24, v[0:3], s[0:1]
; GCN-HSA-NEXT:    s_endpgm
  %ld = load <8 x i32>, ptr addrspace(1) %in
...
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[11:14], off, s[8:11], 0 offset:16
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[19:22], off, s[8:11], 0
; SI-NOHSA-NEXT:    s_mov_b32 s0, s4
; SI-NOHSA-NEXT:    s_mov_b32 s1, s5
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(3)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v10, 31, v3
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(2)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v26, 31, v5
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v24, 31, v4
; SI-NOHSA-NEXT:    v_mov_b32_e32 v23, v4
; SI-NOHSA-NEXT:    v_mov_b32_e32 v25, v5
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v8, 31, v2
...
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v30, 31, v1
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v28, 31, v0
; SI-NOHSA-NEXT:    v_mov_b32_e32 v27, v0
; SI-NOHSA-NEXT:    v_mov_b32_e32 v29, v1
; SI-NOHSA-NEXT:    v_mov_b32_e32 v7, v2
; SI-NOHSA-NEXT:    v_mov_b32_e32 v9, v3
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(1)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v14
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v13
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v34, 31, v12
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v32, 31, v11
; SI-NOHSA-NEXT:    v_mov_b32_e32 v31, v11
; SI-NOHSA-NEXT:    v_mov_b32_e32 v33, v12
; SI-NOHSA-NEXT:    v_mov_b32_e32 v0, v13
; SI-NOHSA-NEXT:    v_mov_b32_e32 v2, v14
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(0)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v14, 31, v22
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v12, 31, v21
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v38, 31, v20
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v36, 31, v19
; SI-NOHSA-NEXT:    v_mov_b32_e32 v35, v19
; SI-NOHSA-NEXT:    v_mov_b32_e32 v37, v20
; SI-NOHSA-NEXT:    v_mov_b32_e32 v11, v21
; SI-NOHSA-NEXT:    v_mov_b32_e32 v13, v22
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[23:26], off, s[0:3], 0 offset:96
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[15:18], off, s[0:3], 0 offset:112
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[27:30], off, s[0:3], 0 offset:64
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[7:10], off, s[0:3], 0 offset:80
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[31:34], off, s[0:3], 0 offset:32
...
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[11:14], off, s[8:11], 0 offset:16
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[19:22], off, s[8:11], 0
; GCNX3-NOHSA-NEXT:    s_mov_b32 s0, s4
; GCNX3-NOHSA-NEXT:    s_mov_b32 s1, s5
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(3)
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v10, 31, v3
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(2)
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v26, 31, v5
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v24, 31, v4
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v23, v4
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v25, v5
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v8, 31, v2
...
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v30, 31, v1
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v28, 31, v0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v27, v0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v29, v1
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v7, v2
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v9, v3
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(1)
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v14
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v13
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v34, 31, v12
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v32, 31, v11
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v31, v11
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v33, v12
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v13
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v14
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(0)
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v14, 31, v22
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v12, 31, v21
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v38, 31, v20
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v36, 31, v19
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v35, v19
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v37, v20
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v11, v21
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v13, v22
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[23:26], off, s[0:3], 0 offset:96
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[15:18], off, s[0:3], 0 offset:112
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[27:30], off, s[0:3], 0 offset:64
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[7:10], off, s[0:3], 0 offset:80
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[31:34], off, s[0:3], 0 offset:32
...
; GCN-HSA-NEXT:    global_load_dwordx4 v[16:19], v36, s[2:3]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(3)
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, v11
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v11, 31, v19
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v9, 31, v18
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v35, 31, v17
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v33, 31, v16
; GCN-HSA-NEXT:    v_mov_b32_e32 v32, v16
; GCN-HSA-NEXT:    v_mov_b32_e32 v34, v17
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, v18
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, v19
...
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[20:21], v[0:3]
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v17, s3
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v16, s2
; GCNX3-HSA-NEXT:    s_add_u32 s2, s0, 0x50
...
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v20, s2
; GCNX3-HSA-NEXT:    s_addc_u32 s1, s1, 0
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[18:19], v[0:3]
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(6)
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v0, v4
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v2, v5
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[20:21], v[0:3]
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s1, s5
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(3)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v16
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v17
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:96
; GCNX3-NOHSA-NEXT:    s_nop 0
...
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v12
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v13
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:64
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v14
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v15
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:80
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, v1
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    global_load_dwordx4 v[16:19], v1, s[2:3] offset:48
; GCN-HSA-NEXT:    global_load_dwordx4 v[12:15], v1, s[2:3] offset:32
; GCN-HSA-NEXT:    global_load_dwordx4 v[8:11], v1, s[2:3] offset:16
; GCN-HSA-NEXT:    global_load_dwordx4 v[4:7], v1, s[2:3]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(3)
...
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[32:35], off, s[8:11], 0 offset:32
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[16:19], off, s[8:11], 0
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[20:23], off, s[8:11], 0 offset:16
; SI-NOHSA-NEXT:    s_mov_b32 s0, s4
; SI-NOHSA-NEXT:    s_mov_b32 s1, s5
...
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v43, 31, v9
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v41, 31, v8
; SI-NOHSA-NEXT:    v_mov_b32_e32 v40, v8
; SI-NOHSA-NEXT:    v_mov_b32_e32 v42, v9
; SI-NOHSA-NEXT:    v_mov_b32_e32 v24, v10
; SI-NOHSA-NEXT:    v_mov_b32_e32 v26, v11
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v51, 31, v13
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v49, 31, v12
; SI-NOHSA-NEXT:    v_mov_b32_e32 v48, v12
; SI-NOHSA-NEXT:    v_mov_b32_e32 v50, v13
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(5)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v11, 31, v7
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v9, 31, v6
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v15, 31, v5
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v13, 31, v4
; SI-NOHSA-NEXT:    v_mov_b32_e32 v12, v4
; SI-NOHSA-NEXT:    v_mov_b32_e32 v14, v5
; SI-NOHSA-NEXT:    v_mov_b32_e32 v8, v6
; SI-NOHSA-NEXT:    v_mov_b32_e32 v10, v7
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(4)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v7, 31, v3
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v5, 31, v2
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v47, 31, v1
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v45, 31, v0
; SI-NOHSA-NEXT:    v_mov_b32_e32 v44, v0
; SI-NOHSA-NEXT:    v_mov_b32_e32 v46, v1
; SI-NOHSA-NEXT:    v_mov_b32_e32 v4, v2
; SI-NOHSA-NEXT:    v_mov_b32_e32 v6, v3
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(3)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v31
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v30
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v55, 31, v29
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v53, 31, v28
; SI-NOHSA-NEXT:    v_mov_b32_e32 v52, v28
; SI-NOHSA-NEXT:    v_mov_b32_e32 v54, v29
; SI-NOHSA-NEXT:    v_mov_b32_e32 v0, v30
; SI-NOHSA-NEXT:    v_mov_b32_e32 v2, v31
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(2)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v59, 31, v35
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v57, 31, v34
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v63, 31, v33
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v61, 31, v32
; SI-NOHSA-NEXT:    v_mov_b32_e32 v60, v32
; SI-NOHSA-NEXT:    v_mov_b32_e32 v62, v33
; SI-NOHSA-NEXT:    v_mov_b32_e32 v56, v34
; SI-NOHSA-NEXT:    v_mov_b32_e32 v58, v35
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(1)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v30, 31, v19
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v28, 31, v18
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v34, 31, v17
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v32, 31, v16
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[36:39], off, s[0:3], 0 offset:240
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(1) expcnt(0)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v38, 31, v23
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v36, 31, v22
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[40:43], off, s[0:3], 0 offset:192
; SI-NOHSA-NEXT:    s_waitcnt expcnt(0)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v42, 31, v21
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v40, 31, v20
; SI-NOHSA-NEXT:    v_mov_b32_e32 v39, v20
; SI-NOHSA-NEXT:    v_mov_b32_e32 v41, v21
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:208
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[12:15], off, s[0:3], 0 offset:160
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[0:3], 0 offset:176
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[44:47], off, s[0:3], 0 offset:128
...
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:112
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[60:63], off, s[0:3], 0 offset:64
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[56:59], off, s[0:3], 0 offset:80
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[39:42], off, s[0:3], 0 offset:32
; SI-NOHSA-NEXT:    v_mov_b32_e32 v35, v22
; SI-NOHSA-NEXT:    v_mov_b32_e32 v37, v23
; SI-NOHSA-NEXT:    v_mov_b32_e32 v31, v16
; SI-NOHSA-NEXT:    v_mov_b32_e32 v33, v17
; SI-NOHSA-NEXT:    v_mov_b32_e32 v27, v18
; SI-NOHSA-NEXT:    v_mov_b32_e32 v29, v19
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[48:51], off, s[0:3], 0 offset:224
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[35:38], off, s[0:3], 0 offset:48
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[31:34], off, s[0:3], 0
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[27:30], off, s[0:3], 0 offset:16
; SI-NOHSA-NEXT:    s_endpgm
;
...
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v23, 31, v5
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v21, 31, v4
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v20, v4
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v22, v5
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GCNX3-HSA-NEXT:    s_add_u32 s2, s0, 0x90
; GCNX3-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[20:23]
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GCNX3-HSA-NEXT:    s_add_u32 s2, s0, 0x60
...
; GCNX3-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCNX3-HSA-NEXT:    s_add_u32 s0, s0, 48
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v22, 31, v1
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v20, 31, v0
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v19, v0
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v21, v1
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v0, s2
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCNX3-HSA-NEXT:    s_addc_u32 s1, s1, 0
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v14, 31, v3
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v12, 31, v2
...
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v11, v2
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v13, v3
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v0, s0
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v1, s1
...
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[8:11], 0 offset:48
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[32:35], off, s[8:11], 0 offset:32
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[16:19], off, s[8:11], 0
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[20:23], off, s[8:11], 0 offset:16
; GCNX3-NOHSA-NEXT:    s_mov_b32 s0, s4
; GCNX3-NOHSA-NEXT:    s_mov_b32 s1, s5
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v27, 31, v11
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v25, 31, v10
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(6)
...
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v43, 31, v9
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v41, 31, v8
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v40, v8
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v42, v9
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v24, v10
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v26, v11
...
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v11, 31, v7
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v9, 31, v6
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v15, 31, v5
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v13, 31, v4
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v12, v4
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v14, v5
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v8, v6
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v10, v7
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(4)
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v7, 31, v3
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v5, 31, v2
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v47, 31, v1
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v45, 31, v0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v44, v0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v46, v1
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v4, v2
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v6, v3
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(3)
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v31
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v30
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v55, 31, v29
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v53, 31, v28
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v52, v28
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v54, v29
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v30
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v31
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(2)
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v59, 31, v35
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v57, 31, v34
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v63, 31, v33
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v61, 31, v32
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v60, v32
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v62, v33
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v56, v34
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v58, v35
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(1)
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v30, 31, v19
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v28, 31, v18
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v34, 31, v17
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v32, 31, v16
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[36:39], off, s[0:3], 0 offset:240
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[40:43], off, s[0:3], 0 offset:192
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(2)
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v38, 31, v23
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v36, 31, v22
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v42, 31, v21
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v40, 31, v20
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v39, v20
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v41, v21
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:208
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[12:15], off, s[0:3], 0 offset:160
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[0:3], 0 offset:176
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[44:47], off, s[0:3], 0 offset:128
...
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:112
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[60:63], off, s[0:3], 0 offset:64
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[56:59], off, s[0:3], 0 offset:80
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[39:42], off, s[0:3], 0 offset:32
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v35, v22
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v37, v23
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v31, v16
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v33, v17
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v27, v18
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v29, v19
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[48:51], off, s[0:3], 0 offset:224
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[35:38], off, s[0:3], 0 offset:48
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[31:34], off, s[0:3], 0
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[27:30], off, s[0:3], 0 offset:16
; GCNX3-NOHSA-NEXT:    s_endpgm
;
...
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v0, 0
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v16, 0
; GCN-GFX900-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-GFX900-HSA-NEXT:    global_load_dwordx4 v[4:7], v0, s[2:3] offset:96
; GCN-GFX900-HSA-NEXT:    global_load_dwordx4 v[8:11], v0, s[2:3] offset:112
; GCN-GFX900-HSA-NEXT:    s_nop 0
; GCN-GFX900-HSA-NEXT:    global_load_dwordx4 v[0:3], v0, s[2:3] offset:80
; GCN-GFX900-HSA-NEXT:    s_nop 0
; GCN-GFX900-HSA-NEXT:    global_load_dwordx4 v[12:15], v16, s[2:3] offset:64
; GCN-GFX900-HSA-NEXT:    global_load_dwordx4 v[28:31], v16, s[2:3] offset:48
; GCN-GFX900-HSA-NEXT:    global_load_dwordx4 v[48:51], v16, s[2:3] offset:32
; GCN-GFX900-HSA-NEXT:    global_load_dwordx4 v[24:27], v16, s[2:3] offset:16
; GCN-GFX900-HSA-NEXT:    s_waitcnt vmcnt(3)
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v35, 31, v13
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v19, 31, v7
; GCN-GFX900-HSA-NEXT:    s_waitcnt vmcnt(1)
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v53, 31, v48
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v52, v48
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v48, 0
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v17, 31, v6
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v39, 31, v11
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v37, 31, v10
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v43, 31, v9
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v41, 31, v8
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v40, v8
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v42, v9
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v36, v10
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v38, v11
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v23, 31, v5
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v21, 31, v4
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v20, v4
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v22, v5
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v16, v6
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v18, v7
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v7, 31, v3
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v5, 31, v2
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v11, 31, v1
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v9, 31, v0
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v8, v0
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v10, v1
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v4, v2
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v6, v3
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v15
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v14
...
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v0, v14
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v2, v15
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v15, 31, v31
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v13, 31, v30
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v47, 31, v29
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v45, 31, v28
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v44, v28
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v46, v29
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v12, v30
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v14, v31
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v31, 31, v51
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v29, 31, v50
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v55, 31, v49
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v54, v49
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v28, v50
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v30, v51
; GCN-GFX900-HSA-NEXT:    global_load_dwordx4 v[48:51], v48, s[2:3]
; GCN-GFX900-HSA-NEXT:    s_waitcnt vmcnt(1)
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v63, 31, v25
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v62, v25
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v25, 0
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v61, 31, v24
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v60, v24
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v24, 0
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[20:23], s[0:1] offset:192
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v25, 0
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v59, 31, v27
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v57, 31, v26
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v56, v26
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v58, v27
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v24, v[40:43], s[0:1] offset:224
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v24, v[36:39], s[0:1] offset:240
; GCN-GFX900-HSA-NEXT:    s_waitcnt vmcnt(3)
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v23, 31, v49
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v26, 31, v51
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v24, 31, v50
; GCN-GFX900-HSA-NEXT:    v_ashrrev_i32_e32 v21, 31, v48
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v20, v48
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v22, v49
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[16:19], s[0:1] offset:208
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[8:11], s[0:1] offset:160
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[4:7], s[0:1] offset:176
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[32:35], s[0:1] offset:128
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[0:3], s[0:1] offset:144
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[44:47], s[0:1] offset:96
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[12:15], s[0:1] offset:112
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[52:55], s[0:1] offset:64
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[28:31], s[0:1] offset:80
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[60:63], s[0:1] offset:32
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[56:59], s[0:1] offset:48
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v25, v[20:23], s[0:1]
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v0, 0
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v23, v50
; GCN-GFX900-HSA-NEXT:    v_mov_b32_e32 v25, v51
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v0, v[23:26], s[0:1] offset:16
...
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v60, 0
; GCN-GFX908-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-GFX908-HSA-NEXT:    global_load_dwordx4 v[4:7], v60, s[2:3] offset:96
; GCN-GFX908-HSA-NEXT:    global_load_dwordx4 v[8:11], v60, s[2:3] offset:112
; GCN-GFX908-HSA-NEXT:    global_load_dwordx4 v[24:27], v60, s[2:3] offset:80
; GCN-GFX908-HSA-NEXT:    global_load_dwordx4 v[12:15], v60, s[2:3] offset:64
; GCN-GFX908-HSA-NEXT:    global_load_dwordx4 v[28:31], v60, s[2:3] offset:48
; GCN-GFX908-HSA-NEXT:    global_load_dwordx4 v[48:51], v60, s[2:3] offset:32
; GCN-GFX908-HSA-NEXT:    global_load_dwordx4 v[0:3], v60, s[2:3] offset:16
; GCN-GFX908-HSA-NEXT:    s_waitcnt vmcnt(6)
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v19, 31, v7
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v17, 31, v6
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v23, 31, v5
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v21, 31, v4
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v20, v4
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v22, v5
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v16, v6
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v18, v7
; GCN-GFX908-HSA-NEXT:    s_waitcnt vmcnt(3)
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v7, 31, v15
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v5, 31, v14
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v35, 31, v13
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v33, 31, v12
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v32, v12
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v34, v13
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v4, v14
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v6, v15
; GCN-GFX908-HSA-NEXT:    s_waitcnt vmcnt(2)
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v15, 31, v31
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v13, 31, v30
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v47, 31, v29
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v45, 31, v28
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v44, v28
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v46, v29
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v12, v30
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v14, v31
; GCN-GFX908-HSA-NEXT:    s_waitcnt vmcnt(1)
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v31, 31, v51
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v29, 31, v50
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v55, 31, v49
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v53, 31, v48
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v52, v48
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v54, v49
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v28, v50
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v30, v51
; GCN-GFX908-HSA-NEXT:    global_load_dwordx4 v[48:51], v60, s[2:3]
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a0, v16
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a1, v17
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a2, v18
; GCN-GFX908-HSA-NEXT:    v_accvgpr_write_b32 a3, v19
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v39, 31, v11
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v37, 31, v10
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v43, 31, v9
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v41, 31, v8
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v40, v8
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v42, v9
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v36, v10
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v38, v11
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v19, 31, v27
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v17, 31, v26
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v11, 31, v25
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v9, 31, v24
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v8, v24
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v10, v25
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v16, v26
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v18, v27
; GCN-GFX908-HSA-NEXT:    s_waitcnt vmcnt(1)
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v59, 31, v3
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v57, 31, v2
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v27, 31, v1
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v25, 31, v0
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v24, v0
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v26, v1
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v56, v2
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v58, v3
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[40:43], s[0:1] offset:224
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[36:39], s[0:1] offset:240
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[20:23], s[0:1] offset:192
; GCN-GFX908-HSA-NEXT:    v_accvgpr_read_b32 v39, a3
; GCN-GFX908-HSA-NEXT:    v_accvgpr_read_b32 v38, a2
; GCN-GFX908-HSA-NEXT:    v_accvgpr_read_b32 v37, a1
; GCN-GFX908-HSA-NEXT:    v_accvgpr_read_b32 v36, a0
; GCN-GFX908-HSA-NEXT:    s_waitcnt vmcnt(3)
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v51
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v50
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v0, v50
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v2, v51
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v23, 31, v49
; GCN-GFX908-HSA-NEXT:    v_ashrrev_i32_e32 v21, 31, v48
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v20, v48
; GCN-GFX908-HSA-NEXT:    v_mov_b32_e32 v22, v49
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[36:39], s[0:1] offset:208
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[8:11], s[0:1] offset:160
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[16:19], s[0:1] offset:176
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[32:35], s[0:1] offset:128
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[4:7], s[0:1] offset:144
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[44:47], s[0:1] offset:96
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[12:15], s[0:1] offset:112
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[52:55], s[0:1] offset:64
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[28:31], s[0:1] offset:80
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[24:27], s[0:1] offset:32
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[56:59], s[0:1] offset:48
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[20:23], s[0:1]
; GCN-GFX908-HSA-NEXT:    global_store_dwordx4 v60, v[0:3], s[0:1] offset:16
...
; SI-NOHSA-NEXT:    s_mov_b32 s8, s6
; SI-NOHSA-NEXT:    s_mov_b32 s9, s7
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[32:35], off, s[8:11], 0 offset:112
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[8:11], 0 offset:96
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[24:27], off, s[8:11], 0 offset:80
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[16:19], off, s[8:11], 0 offset:64
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s8, s6
; GCNX3-NOHSA-NEXT:    s_mov_b32 s9, s7
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[32:35], off, s[8:11], 0 offset:112
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[8:11], 0 offset:96
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[24:27], off, s[8:11], 0 offset:80
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[16:19], off, s[8:11], 0 offset:64
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s1, s5
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v32
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v33
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:224
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v34
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v35
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:240
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(8)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v28
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v29
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:192
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v30
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v31
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:208
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(9)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v24
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v25
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:160
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v26
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v27
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:176
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(10)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v16
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v17
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:128
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v18
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v19
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:144
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(11)
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v20
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v21
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:96
; GCNX3-NOHSA-NEXT:    s_nop 0
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v22
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v23
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:112
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, v1
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    global_load_dwordx4 v[32:35], v1, s[2:3] offset:112
; GCN-HSA-NEXT:    global_load_dwordx4 v[28:31], v1, s[2:3] offset:96
; GCN-HSA-NEXT:    global_load_dwordx4 v[24:27], v1, s[2:3] offset:80
; GCN-HSA-NEXT:    global_load_dwordx4 v[20:23], v1, s[2:3] offset:64
; GCN-HSA-NEXT:    global_load_dwordx4 v[16:19], v1, s[2:3] offset:48
; GCN-HSA-NEXT:    global_load_dwordx4 v[12:15], v1, s[2:3] offset:32
; GCN-HSA-NEXT:    global_load_dwordx4 v[8:11], v1, s[2:3] offset:16
; GCN-HSA-NEXT:    global_load_dwordx4 v[4:7], v1, s[2:3]
...
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[8:11], 0 offset:96
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[8:11], 0 offset:80
...
; SI-NOHSA-NEXT:    s_mov_b32 s5, s1
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(6)
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[28:31], off, s[4:7], 0 offset:96
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[4:7], off, s[4:7], 0 offset:112
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(6)
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[4:7], 0 offset:64
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0 offset:80
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(7)
...
; GCNX3-HSA-NEXT:    s_addc_u32 s3, s3, 0
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[16:19], v[4:5]
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[4:7], v[6:7]
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v23, s5
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v22, s4
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v29, s3
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v28, s2
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[8:11], v[8:9]
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[12:15], v[12:13]
; GCNX3-HSA-NEXT:    flat_load_dwordx4 v[24:27], v[22:23]
...
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v19, s9
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v18, s8
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[18:19], v[4:7]
...
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[2:3], v[24:27]
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[0:1], v[28:31]
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[6:7], v[20:23]
; GCNX3-HSA-NEXT:    s_endpgm
;
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s8, s2
; GCNX3-NOHSA-NEXT:    s_mov_b32 s9, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[8:11], 0 offset:112
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[8:11], 0 offset:96
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[8:11], 0 offset:80
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[24:27], off, s[8:11], 0 offset:64
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s1
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(6)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[28:31], off, s[4:7], 0 offset:96
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[4:7], off, s[4:7], 0 offset:112
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(6)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[4:7], 0 offset:64
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0 offset:80
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(7)
...
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    global_load_dwordx4 v[28:31], v32, s[2:3] offset:96
; GCN-HSA-NEXT:    global_load_dwordx4 v[24:27], v32, s[2:3] offset:112
; GCN-HSA-NEXT:    global_load_dwordx4 v[20:23], v32, s[2:3] offset:64
; GCN-HSA-NEXT:    global_load_dwordx4 v[16:19], v32, s[2:3] offset:80
; GCN-HSA-NEXT:    global_load_dwordx4 v[12:15], v32, s[2:3] offset:32
; GCN-HSA-NEXT:    global_load_dwordx4 v[8:11], v32, s[2:3] offset:48
; GCN-HSA-NEXT:    global_load_dwordx4 v[4:7], v32, s[2:3]
; GCN-HSA-NEXT:    global_load_dwordx4 v[0:3], v32, s[2:3] offset:16
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCN-HSA-NEXT:    global_store_dwordx4 v32, v[28:31], s[0:1] offset:96
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCN-HSA-NEXT:    global_store_dwordx4 v32, v[24:27], s[0:1] offset:112
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCN-HSA-NEXT:    global_store_dwordx4 v32, v[20:23], s[0:1] offset:64
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCN-HSA-NEXT:    global_store_dwordx4 v32, v[16:19], s[0:1] offset:80
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCN-HSA-NEXT:    global_store_dwordx4 v32, v[12:15], s[0:1] offset:32
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCN-HSA-NEXT:    global_store_dwordx4 v32, v[8:11], s[0:1] offset:48
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCN-HSA-NEXT:    global_store_dwordx4 v32, v[4:7], s[0:1]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCN-HSA-NEXT:    global_store_dwordx4 v32, v[0:3], s[0:1] offset:16
; GCN-HSA-NEXT:    s_endpgm
  %ld = load <32 x i32>, ptr addrspace(1) %in
