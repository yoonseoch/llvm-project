...
; RUN: llc -mtriple=amdgpu9.00-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX9 %s
; RUN: llc -mtriple=amdgpu10.10-mesa-mesa3d -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GFX10 %s
