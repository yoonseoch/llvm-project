...
; GFX950-NEXT:    v_mov_b64_e32 v[18:19], s[36:37]
; GFX950-NEXT:    s_and_b64 vcc, exec, s[34:35]
; GFX950-NEXT:    v_mov_b32_e32 v20, v1
; GFX950-NEXT:    v_mov_b32_e32 v22, v1
; GFX950-NEXT:    v_mov_b32_e32 v23, v1
; GFX950-NEXT:    v_mov_b32_e32 v24, v1
; GFX950-NEXT:    v_mov_b32_e32 v26, v1
; GFX950-NEXT:    v_mov_b32_e32 v25, v1
; GFX950-NEXT:    v_mov_b32_e32 v27, v1
; GFX950-NEXT:    v_mov_b32_e32 v28, v1
; GFX950-NEXT:    v_mov_b32_e32 v29, v1
; GFX950-NEXT:  .LBB0_1: ; %bb4
; GFX950-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX950-NEXT:    v_mov_b32_e32 v21, v1
; GFX950-NEXT:    v_lshlrev_b64 v[10:11], 3, v[20:21]
; GFX950-NEXT:    v_lshl_add_u64 v[10:11], s[38:39], 0, v[10:11]
; GFX950-NEXT:    global_load_dwordx4 v[14:17], v[10:11], off
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    v_lshl_add_u64 v[10:11], v[0:1], 3, s[38:39]
; GFX950-NEXT:    s_waitcnt vmcnt(1)
; GFX950-NEXT:    v_or_b32_e32 v0, v40, v6
; GFX950-NEXT:    v_or_b32_e32 v21, v41, v7
; GFX950-NEXT:    v_or_b32_e32 v30, v42, v8
; GFX950-NEXT:    v_or_b32_e32 v31, v43, v9
; GFX950-NEXT:    global_load_dwordx4 v[10:13], v[10:11], off
; GFX950-NEXT:    v_or_b32_e32 v26, v5, v26
; GFX950-NEXT:    v_or_b32_e32 v24, v4, v24
; GFX950-NEXT:    v_or_b32_e32 v23, v3, v23
; GFX950-NEXT:    v_or_b32_e32 v22, v2, v22
; GFX950-NEXT:    v_or_b32_e32 v20, 1, v20
...
; GFX950-NEXT:    s_waitcnt vmcnt(1)
; GFX950-NEXT:    v_or_b32_e32 v17, v17, v31
; GFX950-NEXT:    v_or_b32_e32 v16, v16, v30
; GFX950-NEXT:    v_or_b32_e32 v15, v15, v21
; GFX950-NEXT:    v_or_b32_e32 v14, v14, v0
; GFX950-NEXT:    scratch_store_dwordx4 off, v[14:17], s33
; GFX950-NEXT:    flat_load_dword v0, v[18:19]
; GFX950-NEXT:    s_waitcnt vmcnt(0)
; GFX950-NEXT:    v_or_b32_e32 v29, v13, v29
; GFX950-NEXT:    v_or_b32_e32 v28, v12, v28
; GFX950-NEXT:    v_or_b32_e32 v27, v11, v27
; GFX950-NEXT:    v_or_b32_e32 v25, v10, v25
; GFX950-NEXT:    s_mov_b64 vcc, vcc
; GFX950-NEXT:    s_cbranch_vccz .LBB0_1
; GFX950-NEXT:  ; %bb.2: ; %bb2
; GFX950-NEXT:    v_or_b32_e32 v3, v29, v26
; GFX950-NEXT:    v_or_b32_e32 v2, v28, v24
; GFX950-NEXT:    v_or_b32_e32 v1, v27, v23
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    v_or_b32_e32 v0, v25, v22
