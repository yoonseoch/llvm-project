...
; CHECK-NEXT:    flat_load_dwordx4 v[6:9], v[2:3] offset:16
; CHECK-NEXT:    flat_load_dwordx4 v[2:5], v[2:3]
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    flat_load_dwordx4 v[6:9], v[2:3] offset:15
; CHECK-NEXT:    flat_load_dwordx4 v[2:5], v[2:3]
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[6:9] offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(1)
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[2:5]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    global_load_dwordx4 v[6:9], v[2:3], off offset:15
; CHECK-NEXT:    global_load_dwordx4 v[2:5], v[2:3], off
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[6:9] offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_read_b128 v[6:9], v2 offset:16
; CHECK-NEXT:    ds_read_b128 v[2:5], v2
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_read_b128 v[6:9], v2 offset:15
; CHECK-NEXT:    ds_read2_b64 v[2:5], v2 offset1:1
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[6:9] offset:15
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_read2_b64 v[6:9], v2 offset0:2 offset1:3
; CHECK-NEXT:    ds_read2_b64 v[2:5], v2 offset1:1
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[6:9] offset:16
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
...
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[6:9]
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK-NEXT:    buffer_load_dword v3, v2, s[0:3], 0 offen offset:15
; CHECK-NEXT:    buffer_load_dword v4, v2, s[0:3], 0 offen offset:19
; CHECK-NEXT:    buffer_load_dword v5, v2, s[0:3], 0 offen offset:23
; CHECK-NEXT:    buffer_load_dword v6, v2, s[0:3], 0 offen offset:27
...
; CHECK-NEXT:    global_store_dwordx4 v[0:1], v[7:10], off
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    global_store_dwordx4 v[0:1], v[3:6], off offset:15
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    flat_load_dwordx4 v[5:8], v[1:2] offset:16
; CHECK-NEXT:    flat_load_dwordx4 v[1:4], v[1:2]
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    flat_load_dwordx4 v[5:8], v[1:2]
; CHECK-NEXT:    flat_load_dwordx4 v[1:4], v[1:2] offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    flat_load_dwordx4 v[5:8], v[1:2] offset:15
; CHECK-NEXT:    flat_load_dwordx4 v[1:4], v[1:2]
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
...
; CHECK-NEXT:    flat_load_dwordx4 v[1:4], v[1:2]
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; CHECK-NEXT:    ds_write_b128 v0, v[5:8] offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(1)
; CHECK-NEXT:    ds_write_b128 v0, v[1:4]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_read2_b64 v[5:8], v1 offset0:2 offset1:3
; CHECK-NEXT:    ds_read2_b64 v[1:4], v1 offset1:1
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
; CHECK-NEXT:    ds_write2_b64 v0, v[5:6], v[7:8] offset0:2 offset1:3
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_read2_b64 v[5:8], v1 offset1:1
; CHECK-NEXT:    ds_read_b128 v[1:4], v1 offset:15
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
; CHECK-NEXT:    ds_write2_b64 v0, v[5:6], v[7:8] offset1:1
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
; CHECK-NEXT:    ds_write_b128 v0, v[1:4] offset:15
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_read_b128 v[5:8], v1 offset:15
; CHECK-NEXT:    ds_read_b128 v[1:4], v1
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
; CHECK-NEXT:    ds_write_b128 v0, v[5:8] offset:15
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_read_b128 v[5:8], v1 offset:16
; CHECK-NEXT:    ds_read_b128 v[1:4], v1
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
; CHECK-NEXT:    ds_write_b128 v0, v[5:8] offset:16
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
...
; CHECK-NEXT:    flat_load_dwordx4 v[1:4], v[1:2]
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; CHECK-NEXT:    buffer_store_dword v8, v0, s[0:3], 0 offen offset:28
...
; CHECK-NEXT:    flat_load_dwordx4 v[1:4], v[1:2]
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; CHECK-NEXT:    buffer_store_dword v8, v0, s[0:3], 0 offen offset:27
; CHECK-NEXT:    buffer_store_dword v7, v0, s[0:3], 0 offen offset:23
; CHECK-NEXT:    buffer_store_dword v6, v0, s[0:3], 0 offen offset:19
; CHECK-NEXT:    buffer_store_dword v5, v0, s[0:3], 0 offen offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    buffer_store_dword v4, v0, s[0:3], 0 offen offset:12
; CHECK-NEXT:    buffer_store_dword v3, v0, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_store_dword v2, v0, s[0:3], 0 offen offset:4
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_read2_b64 v[5:8], v1 offset1:1
; CHECK-NEXT:    ds_read2_b64 v[1:4], v1 offset0:2 offset1:3
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
; CHECK-NEXT:    buffer_store_dword v6, v0, s[0:3], 0 offen offset:4
; CHECK-NEXT:    buffer_store_dword v5, v0, s[0:3], 0 offen
; CHECK-NEXT:    buffer_store_dword v8, v0, s[0:3], 0 offen offset:12
...
; CHECK-NEXT:    buffer_store_dword v4, v0, s[0:3], 0 offen offset:28
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_read_b128 v[5:8], v1
; CHECK-NEXT:    ds_read_b128 v[1:4], v1 offset:15
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
; CHECK-NEXT:    buffer_store_dword v8, v0, s[0:3], 0 offen offset:12
; CHECK-NEXT:    buffer_store_dword v7, v0, s[0:3], 0 offen offset:8
...
; CHECK-NEXT:    buffer_store_dword v5, v0, s[0:3], 0 offen
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    buffer_store_dword v4, v0, s[0:3], 0 offen offset:27
; CHECK-NEXT:    buffer_store_dword v3, v0, s[0:3], 0 offen offset:23
; CHECK-NEXT:    buffer_store_dword v2, v0, s[0:3], 0 offen offset:19
; CHECK-NEXT:    buffer_store_dword v1, v0, s[0:3], 0 offen offset:15
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_read_b128 v[5:8], v1
; CHECK-NEXT:    ds_read_b128 v[1:4], v1 offset:16
; CHECK-NEXT:    s_waitcnt lgkmcnt(1)
; CHECK-NEXT:    buffer_store_dword v8, v0, s[0:3], 0 offen offset:12
; CHECK-NEXT:    buffer_store_dword v7, v0, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_store_dword v6, v0, s[0:3], 0 offen offset:4
