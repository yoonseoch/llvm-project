...
; RUN: llc -mtriple=amdgpu9.08-amd-amdhsa %s -o - | FileCheck %s
...
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[8:9] offset:16
...
; CHECK-NEXT:    global_load_dwordx4 v[4:7], v12, s[2:3]
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v12, s[2:3] offset:16
...
; CHECK-NEXT:    s_waitcnt vmcnt(3)
; CHECK-NEXT:    global_store_dwordx4 v12, v[4:7], s[0:1]
; CHECK-NEXT:    s_waitcnt vmcnt(3)
; CHECK-NEXT:    global_store_dwordx4 v12, v[0:3], s[0:1] offset:16
; CHECK-NEXT:    s_endpgm
entry:
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    global_load_dwordx4 v[28:31], v32, s[2:3]
; CHECK-NEXT:    global_load_dwordx4 v[24:27], v32, s[2:3] offset:16
; CHECK-NEXT:    global_load_dwordx4 v[20:23], v32, s[2:3] offset:32
; CHECK-NEXT:    global_load_dwordx4 v[16:19], v32, s[2:3] offset:48
; CHECK-NEXT:    global_load_dwordx4 v[12:15], v32, s[2:3] offset:64
; CHECK-NEXT:    global_load_dwordx4 v[8:11], v32, s[2:3] offset:80
; CHECK-NEXT:    global_load_dwordx4 v[4:7], v32, s[2:3] offset:96
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v32, s[2:3] offset:112
; CHECK-NEXT:    s_waitcnt vmcnt(7)
; CHECK-NEXT:    global_store_dwordx4 v32, v[28:31], s[0:1]
; CHECK-NEXT:    s_waitcnt vmcnt(7)
; CHECK-NEXT:    global_store_dwordx4 v32, v[24:27], s[0:1] offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(7)
; CHECK-NEXT:    global_store_dwordx4 v32, v[20:23], s[0:1] offset:32
; CHECK-NEXT:    s_waitcnt vmcnt(7)
; CHECK-NEXT:    global_store_dwordx4 v32, v[16:19], s[0:1] offset:48
; CHECK-NEXT:    s_waitcnt vmcnt(7)
; CHECK-NEXT:    global_store_dwordx4 v32, v[12:15], s[0:1] offset:64
; CHECK-NEXT:    s_waitcnt vmcnt(7)
; CHECK-NEXT:    global_store_dwordx4 v32, v[8:11], s[0:1] offset:80
; CHECK-NEXT:    s_waitcnt vmcnt(7)
; CHECK-NEXT:    global_store_dwordx4 v32, v[4:7], s[0:1] offset:96
; CHECK-NEXT:    s_waitcnt vmcnt(7)
; CHECK-NEXT:    global_store_dwordx4 v32, v[0:3], s[0:1] offset:112
; CHECK-NEXT:    s_endpgm
entry:
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    global_load_dwordx4 v[8:11], v24, s[0:1] offset:112
; CHECK-NEXT:    global_load_dwordx4 v[12:15], v24, s[0:1] offset:96
; CHECK-NEXT:    global_load_dwordx4 v[20:23], v24, s[0:1] offset:80
; CHECK-NEXT:    global_load_dwordx4 v[16:19], v24, s[0:1] offset:64
; CHECK-NEXT:    global_load_dwordx4 v[4:7], v24, s[0:1] offset:48
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v24, s[0:1] offset:32
...
; CHECK-NEXT:    buffer_store_dword v11, v25, s[20:23], 0 offen offset:124
; CHECK-NEXT:    buffer_store_dword v10, v25, s[20:23], 0 offen offset:120
; CHECK-NEXT:    buffer_store_dword v9, v25, s[20:23], 0 offen offset:116
; CHECK-NEXT:    buffer_store_dword v8, v25, s[20:23], 0 offen offset:112
; CHECK-NEXT:    global_load_dwordx4 v[8:11], v24, s[0:1] offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(9)
; CHECK-NEXT:    buffer_store_dword v15, v25, s[20:23], 0 offen offset:108
; CHECK-NEXT:    buffer_store_dword v14, v25, s[20:23], 0 offen offset:104
; CHECK-NEXT:    buffer_store_dword v13, v25, s[20:23], 0 offen offset:100
; CHECK-NEXT:    buffer_store_dword v12, v25, s[20:23], 0 offen offset:96
; CHECK-NEXT:    global_load_dwordx4 v[12:15], v24, s[0:1]
; CHECK-NEXT:    s_waitcnt vmcnt(13)
; CHECK-NEXT:    buffer_store_dword v23, v25, s[20:23], 0 offen offset:92
; CHECK-NEXT:    buffer_store_dword v22, v25, s[20:23], 0 offen offset:88
; CHECK-NEXT:    buffer_store_dword v21, v25, s[20:23], 0 offen offset:84
; CHECK-NEXT:    buffer_store_dword v20, v25, s[20:23], 0 offen offset:80
; CHECK-NEXT:    s_waitcnt vmcnt(16)
; CHECK-NEXT:    buffer_store_dword v19, v25, s[20:23], 0 offen offset:76
; CHECK-NEXT:    buffer_store_dword v18, v25, s[20:23], 0 offen offset:72
; CHECK-NEXT:    buffer_store_dword v17, v25, s[20:23], 0 offen offset:68
; CHECK-NEXT:    buffer_store_dword v16, v25, s[20:23], 0 offen offset:64
; CHECK-NEXT:    s_waitcnt vmcnt(19)
; CHECK-NEXT:    buffer_store_dword v7, v25, s[20:23], 0 offen offset:60
; CHECK-NEXT:    buffer_store_dword v6, v25, s[20:23], 0 offen offset:56
; CHECK-NEXT:    buffer_store_dword v5, v25, s[20:23], 0 offen offset:52
; CHECK-NEXT:    buffer_store_dword v4, v25, s[20:23], 0 offen offset:48
; CHECK-NEXT:    s_waitcnt vmcnt(22)
; CHECK-NEXT:    buffer_store_dword v3, v25, s[20:23], 0 offen offset:44
; CHECK-NEXT:    buffer_store_dword v2, v25, s[20:23], 0 offen offset:40
; CHECK-NEXT:    buffer_store_dword v1, v25, s[20:23], 0 offen offset:36
; CHECK-NEXT:    buffer_store_dword v0, v25, s[20:23], 0 offen offset:32
; CHECK-NEXT:    s_waitcnt vmcnt(21)
; CHECK-NEXT:    buffer_store_dword v11, v25, s[20:23], 0 offen offset:28
; CHECK-NEXT:    buffer_store_dword v10, v25, s[20:23], 0 offen offset:24
; CHECK-NEXT:    buffer_store_dword v9, v25, s[20:23], 0 offen offset:20
; CHECK-NEXT:    buffer_store_dword v8, v25, s[20:23], 0 offen offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(20)
; CHECK-NEXT:    buffer_store_dword v15, v25, s[20:23], 0 offen offset:12
; CHECK-NEXT:    buffer_store_dword v14, v25, s[20:23], 0 offen offset:8
; CHECK-NEXT:    buffer_store_dword v13, v25, s[20:23], 0 offen offset:4
; CHECK-NEXT:    buffer_store_dword v12, v25, s[20:23], 0 offen
; CHECK-NEXT:    s_endpgm
entry:
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    global_load_dwordx4 v[12:15], v24, s[0:1]
; CHECK-NEXT:    global_load_dwordx4 v[20:23], v24, s[0:1] offset:16
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v24, s[0:1] offset:32
; CHECK-NEXT:    global_load_dwordx4 v[4:7], v24, s[0:1] offset:48
; CHECK-NEXT:    global_load_dwordx4 v[8:11], v24, s[0:1] offset:64
; CHECK-NEXT:    global_load_dwordx4 v[16:19], v24, s[0:1] offset:80
; CHECK-NEXT:    s_waitcnt vmcnt(5)
; CHECK-NEXT:    ds_write_b128 v24, v[12:15]
; CHECK-NEXT:    s_waitcnt vmcnt(4)
; CHECK-NEXT:    ds_write_b128 v24, v[20:23] offset:16
; CHECK-NEXT:    global_load_dwordx4 v[12:15], v24, s[0:1] offset:96
; CHECK-NEXT:    global_load_dwordx4 v[20:23], v24, s[0:1] offset:112
; CHECK-NEXT:    s_waitcnt vmcnt(5)
; CHECK-NEXT:    ds_write_b128 v24, v[0:3] offset:32
; CHECK-NEXT:    s_waitcnt vmcnt(4)
; CHECK-NEXT:    ds_write_b128 v24, v[4:7] offset:48
; CHECK-NEXT:    s_waitcnt vmcnt(3)
; CHECK-NEXT:    ds_write_b128 v24, v[8:11] offset:64
; CHECK-NEXT:    s_waitcnt vmcnt(2)
; CHECK-NEXT:    ds_write_b128 v24, v[16:19] offset:80
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    ds_write_b128 v24, v[12:15] offset:96
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    ds_write_b128 v24, v[20:23] offset:112
; CHECK-NEXT:    s_endpgm
entry:
...
; CHECK-NEXT:    ds_read2_b64 v[4:7], v16 offset1:1
; CHECK-NEXT:    ds_read2_b64 v[8:11], v16 offset0:2 offset1:3
; CHECK-NEXT:    ds_read2_b64 v[12:15], v16 offset0:4 offset1:5
; CHECK-NEXT:    ds_read2_b64 v[0:3], v16 offset0:6 offset1:7
; CHECK-NEXT:    s_add_u32 flat_scratch_lo, s12, s17
; CHECK-NEXT:    s_addc_u32 flat_scratch_hi, s13, 0
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_mov_b32_e32 v21, s1
; CHECK-NEXT:    v_mov_b32_e32 v20, s0
; CHECK-NEXT:    flat_store_dwordx4 v[20:21], v[4:7]
; CHECK-NEXT:    flat_store_dwordx4 v[20:21], v[8:11] offset:16
; CHECK-NEXT:    flat_store_dwordx4 v[20:21], v[12:15] offset:32
; CHECK-NEXT:    ds_read2_b64 v[4:7], v16 offset0:8 offset1:9
; CHECK-NEXT:    ds_read2_b64 v[8:11], v16 offset0:10 offset1:11
; CHECK-NEXT:    ds_read_b128 v[12:15], v16 offset:96
; CHECK-NEXT:    ds_read_b128 v[16:19], v16 offset:112
; CHECK-NEXT:    flat_store_dwordx4 v[20:21], v[0:3] offset:48
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[20:21], v[4:7] offset:64
; CHECK-NEXT:    flat_store_dwordx4 v[20:21], v[8:11] offset:80
; CHECK-NEXT:    flat_store_dwordx4 v[20:21], v[12:15] offset:96
