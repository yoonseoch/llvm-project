...
; RUN: llc -mtriple=amdgpu6.00-amd-amdhsa < %s | FileCheck -check-prefix=SI %s
; RUN: llc -mtriple=amdgpu8.02-amd-amdhsa < %s | FileCheck -check-prefix=VI %s
...
; RUN: llc -mtriple=amdgpu12.50-amd-amdhsa -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-REAL16 %s
...
; GFX1250-REAL16:       ; %bb.0:
; GFX1250-REAL16-NEXT:    global_prefetch_b8 v0, null scope:SCOPE_SE
...
; SI-NEXT:    v_lshlrev_b32_e32 v11, 5, v0
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b64 s[0:1], s[14:15]
; SI-NEXT:    v_mov_b32_e32 v12, 0
; SI-NEXT:    buffer_load_dwordx4 v[4:7], v[11:12], s[0:3], 0 addr64
; SI-NEXT:    buffer_load_dwordx4 v[0:3], v[11:12], s[0:3], 0 addr64 offset:16
...
; SI-NEXT:    v_cndmask_b32_e32 v10, v3, v13, vcc
; SI-NEXT:    s_cselect_b64 vcc, -1, 0
; SI-NEXT:    s_cmp_eq_u32 s7, 12
; SI-NEXT:    v_or_b32_e32 v3, v8, v9
; SI-NEXT:    v_cndmask_b32_e32 v9, v15, v13, vcc
; SI-NEXT:    s_cselect_b64 vcc, -1, 0
; SI-NEXT:    s_cmp_eq_u32 s7, 13
; SI-NEXT:    v_lshrrev_b32_e32 v16, 16, v2
; SI-NEXT:    v_and_b32_e32 v8, 0xffff, v10
; SI-NEXT:    v_lshlrev_b32_e32 v9, 16, v9
; SI-NEXT:    v_cndmask_b32_e32 v2, v2, v13, vcc
; SI-NEXT:    s_cselect_b64 vcc, -1, 0
; SI-NEXT:    s_cmp_eq_u32 s7, 10
; SI-NEXT:    v_or_b32_e32 v10, v8, v9
; SI-NEXT:    v_cndmask_b32_e32 v8, v16, v13, vcc
; SI-NEXT:    s_cselect_b64 vcc, -1, 0
; SI-NEXT:    s_cmp_eq_u32 s7, 11
; SI-NEXT:    v_lshrrev_b32_e32 v19, 16, v1
; SI-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; SI-NEXT:    v_lshlrev_b32_e32 v8, 16, v8
; SI-NEXT:    v_cndmask_b32_e32 v1, v1, v13, vcc
; SI-NEXT:    s_cselect_b64 vcc, -1, 0
; SI-NEXT:    s_cmp_eq_u32 s7, 8
; SI-NEXT:    v_or_b32_e32 v9, v2, v8
; SI-NEXT:    v_cndmask_b32_e32 v2, v19, v13, vcc
; SI-NEXT:    s_cselect_b64 vcc, -1, 0
...
; SI-NEXT:    v_cndmask_b32_e32 v1, v7, v13, vcc
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; SI-NEXT:    v_or_b32_e32 v7, v0, v1
; SI-NEXT:    buffer_store_dwordx4 v[7:10], v[11:12], s[12:15], 0 addr64 offset:16
; SI-NEXT:    buffer_store_dwordx4 v[3:6], v[11:12], s[12:15], 0 addr64
; SI-NEXT:    s_endpgm
;
