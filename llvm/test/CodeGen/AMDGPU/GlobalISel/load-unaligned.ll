...
; RUN: llc -global-isel -mtriple=amdgpu9.00-amd-amdpal -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX9 %s
; RUN: llc -global-isel -mtriple=amdgpu7.01-amd-amdpal -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX7 %s
; RUN: llc -global-isel -mtriple=amdgpu10.10-amd-amdpal -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX10 %s
; RUN: llc -global-isel -mtriple=amdgpu11.00-amd-amdpal -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX11 %s
...
; GFX9-NEXT:    global_load_dwordx4 v[0:3], v8, s[0:1] offset:16
...
; GFX7-NEXT:    buffer_load_dwordx4 v[4:7], off, s[0:3], 0
...
; GFX7-NEXT:    v_readfirstlane_b32 s2, v6
; GFX7-NEXT:    v_readfirstlane_b32 s3, v7
...
; GFX10-NEXT:    global_load_dwordx4 v[0:3], v8, s[0:1] offset:16
...
; GFX11-NEXT:    global_load_b128 v[4:7], v8, s[0:1]
; GFX11-NEXT:    global_load_b128 v[0:3], v8, s[0:1] offset:16
...
; GFX11-NEXT:    v_readfirstlane_b32 s10, v2
; GFX11-NEXT:    v_readfirstlane_b32 s11, v3
