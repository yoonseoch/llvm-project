...
; GFX7-NEXT:    v_mov_b32_e32 v19, v2
; GFX7-NEXT:    v_mov_b32_e32 v0, v3
; GFX7-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v17, v14, 0
; GFX7-NEXT:    v_mov_b32_e32 v18, v1
; GFX7-NEXT:    v_mov_b32_e32 v20, v4
; GFX7-NEXT:    v_mov_b32_e32 v1, v5
; GFX7-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v18, v13, v[2:3]
; GFX7-NEXT:    v_mov_b32_e32 v21, v6
; GFX7-NEXT:    v_mov_b32_e32 v16, v7
; GFX7-NEXT:    v_mul_lo_u32 v27, v20, v11
; GFX7-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v19, v12, v[4:5]
; GFX7-NEXT:    v_mul_lo_u32 v26, v1, v10
; GFX7-NEXT:    v_mul_lo_u32 v14, v18, v14
; GFX7-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v0, v11, v[2:3]
; GFX7-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v17, v10, 0
; GFX7-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v20, v10, v[4:5]
; GFX7-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v18, v9, v[2:3]
; GFX7-NEXT:    v_cndmask_b32_e64 v24, 0, 1, s[4:5]
; GFX7-NEXT:    v_mad_u64_u32 v[22:23], s[6:7], v1, v9, v[6:7]
; GFX7-NEXT:    v_mad_u64_u32 v[2:3], vcc, v19, v8, v[4:5]
; GFX7-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v17, v12, 0
; GFX7-NEXT:    v_addc_u32_e32 v24, vcc, 0, v24, vcc
; GFX7-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v21, v8, v[22:23]
; GFX7-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v18, v11, v[4:5]
; GFX7-NEXT:    v_cndmask_b32_e64 v25, 0, 1, s[4:5]
; GFX7-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v19, v10, v[22:23]
; GFX7-NEXT:    v_addc_u32_e64 v25, s[4:5], 0, v25, s[4:5]
; GFX7-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v0, v9, v[4:5]
; GFX7-NEXT:    v_addc_u32_e64 v25, s[4:5], 0, v25, s[4:5]
; GFX7-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v20, v8, v[22:23]
; GFX7-NEXT:    v_addc_u32_e64 v23, s[4:5], 0, v25, s[4:5]
; GFX7-NEXT:    v_mul_lo_u32 v25, v21, v9
; GFX7-NEXT:    v_mad_u64_u32 v[21:22], s[4:5], v17, v13, v[5:6]
; GFX7-NEXT:    v_mul_lo_u32 v13, v19, v13
; GFX7-NEXT:    v_mad_u64_u32 v[5:6], s[6:7], v18, v12, v[21:22]
; GFX7-NEXT:    v_mul_lo_u32 v12, v0, v12
; GFX7-NEXT:    v_mad_u64_u32 v[21:22], vcc, v19, v11, v[5:6]
; GFX7-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v17, v11, v[3:4]
; GFX7-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s[8:9]
; GFX7-NEXT:    v_mad_u64_u32 v[3:4], s[8:9], v18, v10, v[5:6]
; GFX7-NEXT:    v_mad_u64_u32 v[5:6], s[10:11], v0, v10, v[21:22]
; GFX7-NEXT:    v_addc_u32_e64 v21, s[8:9], 0, v11, s[8:9]
; GFX7-NEXT:    v_mad_u64_u32 v[10:11], s[8:9], v19, v9, v[3:4]
; GFX7-NEXT:    v_mad_u64_u32 v[3:4], s[12:13], v20, v9, v[5:6]
; GFX7-NEXT:    v_addc_u32_e64 v19, s[8:9], 0, v21, s[8:9]
; GFX7-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v0, v8, v[10:11]
; GFX7-NEXT:    v_mad_u64_u32 v[10:11], s[14:15], v1, v8, v[3:4]
; GFX7-NEXT:    v_mad_u64_u32 v[0:1], s[16:17], v17, v8, 0
; GFX7-NEXT:    v_addc_u32_e64 v19, s[8:9], 0, v19, s[8:9]
; GFX7-NEXT:    v_mad_u64_u32 v[3:4], s[8:9], v17, v9, v[1:2]
; GFX7-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s[8:9]
; GFX7-NEXT:    v_mad_u64_u32 v[1:2], s[8:9], v18, v8, v[3:4]
; GFX7-NEXT:    v_addc_u32_e64 v3, s[8:9], v9, v5, s[8:9]
; GFX7-NEXT:    v_mul_lo_u32 v9, v17, v15
; GFX7-NEXT:    v_addc_u32_e64 v4, s[8:9], v24, v6, s[8:9]
; GFX7-NEXT:    v_addc_u32_e64 v5, s[8:9], v19, v10, s[8:9]
; GFX7-NEXT:    v_addc_u32_e64 v6, s[8:9], v23, v11, s[8:9]
; GFX7-NEXT:    v_addc_u32_e64 v7, s[8:9], v7, v9, s[8:9]
; GFX7-NEXT:    v_addc_u32_e64 v7, s[8:9], v7, v14, s[14:15]
; GFX7-NEXT:    v_addc_u32_e64 v7, s[8:9], v7, v13, s[12:13]
; GFX7-NEXT:    v_addc_u32_e64 v7, s[8:9], v7, v12, s[10:11]
; GFX7-NEXT:    v_addc_u32_e32 v7, vcc, v7, v27, vcc
; GFX7-NEXT:    v_addc_u32_e64 v7, vcc, v7, v26, s[6:7]
; GFX7-NEXT:    v_addc_u32_e64 v7, vcc, v7, v25, s[4:5]
; GFX7-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v16, v8, v[7:8]
...
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v17, v14, 0
; GFX8-NEXT:    v_mov_b32_e32 v18, v1
; GFX8-NEXT:    v_mov_b32_e32 v20, v4
; GFX8-NEXT:    v_mov_b32_e32 v1, v5
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v18, v13, v[2:3]
; GFX8-NEXT:    v_mov_b32_e32 v21, v6
; GFX8-NEXT:    v_mov_b32_e32 v16, v7
; GFX8-NEXT:    v_mul_lo_u32 v27, v20, v11
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v19, v12, v[4:5]
; GFX8-NEXT:    v_mul_lo_u32 v26, v1, v10
; GFX8-NEXT:    v_mul_lo_u32 v14, v18, v14
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v0, v11, v[2:3]
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v17, v10, 0
; GFX8-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v20, v10, v[4:5]
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v18, v9, v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e64 v24, 0, 1, s[4:5]
; GFX8-NEXT:    v_mad_u64_u32 v[22:23], s[6:7], v1, v9, v[6:7]
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], vcc, v19, v8, v[4:5]
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v17, v12, 0
; GFX8-NEXT:    v_addc_u32_e32 v24, vcc, 0, v24, vcc
; GFX8-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v21, v8, v[22:23]
; GFX8-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v18, v11, v[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v25, 0, 1, s[4:5]
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v19, v10, v[22:23]
; GFX8-NEXT:    v_addc_u32_e64 v25, s[4:5], 0, v25, s[4:5]
; GFX8-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v0, v9, v[4:5]
; GFX8-NEXT:    v_addc_u32_e64 v25, s[4:5], 0, v25, s[4:5]
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v20, v8, v[22:23]
; GFX8-NEXT:    v_addc_u32_e64 v23, s[4:5], 0, v25, s[4:5]
; GFX8-NEXT:    v_mul_lo_u32 v25, v21, v9
; GFX8-NEXT:    v_mad_u64_u32 v[21:22], s[4:5], v17, v13, v[5:6]
; GFX8-NEXT:    v_mul_lo_u32 v13, v19, v13
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[6:7], v18, v12, v[21:22]
; GFX8-NEXT:    v_mul_lo_u32 v12, v0, v12
; GFX8-NEXT:    v_mad_u64_u32 v[21:22], vcc, v19, v11, v[5:6]
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v17, v11, v[3:4]
; GFX8-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s[8:9]
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[8:9], v18, v10, v[5:6]
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[10:11], v0, v10, v[21:22]
; GFX8-NEXT:    v_addc_u32_e64 v21, s[8:9], 0, v11, s[8:9]
; GFX8-NEXT:    v_mad_u64_u32 v[10:11], s[8:9], v19, v9, v[3:4]
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[12:13], v20, v9, v[5:6]
; GFX8-NEXT:    v_addc_u32_e64 v19, s[8:9], 0, v21, s[8:9]
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v0, v8, v[10:11]
; GFX8-NEXT:    v_mad_u64_u32 v[10:11], s[14:15], v1, v8, v[3:4]
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[16:17], v17, v8, 0
; GFX8-NEXT:    v_addc_u32_e64 v19, s[8:9], 0, v19, s[8:9]
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[8:9], v17, v9, v[1:2]
; GFX8-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s[8:9]
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[8:9], v18, v8, v[3:4]
; GFX8-NEXT:    v_addc_u32_e64 v3, s[8:9], v9, v5, s[8:9]
; GFX8-NEXT:    v_mul_lo_u32 v9, v17, v15
; GFX8-NEXT:    v_addc_u32_e64 v4, s[8:9], v24, v6, s[8:9]
; GFX8-NEXT:    v_addc_u32_e64 v5, s[8:9], v19, v10, s[8:9]
; GFX8-NEXT:    v_addc_u32_e64 v6, s[8:9], v23, v11, s[8:9]
; GFX8-NEXT:    v_addc_u32_e64 v7, s[8:9], v7, v9, s[8:9]
; GFX8-NEXT:    v_addc_u32_e64 v7, s[8:9], v7, v14, s[14:15]
; GFX8-NEXT:    v_addc_u32_e64 v7, s[8:9], v7, v13, s[12:13]
; GFX8-NEXT:    v_addc_u32_e64 v7, s[8:9], v7, v12, s[10:11]
; GFX8-NEXT:    v_addc_u32_e32 v7, vcc, v7, v27, vcc
; GFX8-NEXT:    v_addc_u32_e64 v7, vcc, v7, v26, s[6:7]
; GFX8-NEXT:    v_addc_u32_e64 v7, vcc, v7, v25, s[4:5]
; GFX8-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v16, v8, v[7:8]
...
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v17, v14, 0
; GFX9-NEXT:    v_mov_b32_e32 v18, v1
; GFX9-NEXT:    v_mov_b32_e32 v20, v4
; GFX9-NEXT:    v_mov_b32_e32 v1, v5
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v18, v13, v[2:3]
; GFX9-NEXT:    v_mov_b32_e32 v21, v6
; GFX9-NEXT:    v_mov_b32_e32 v16, v7
; GFX9-NEXT:    v_mul_lo_u32 v27, v20, v11
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v19, v12, v[4:5]
; GFX9-NEXT:    v_mul_lo_u32 v26, v1, v10
; GFX9-NEXT:    v_mul_lo_u32 v14, v18, v14
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v0, v11, v[2:3]
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v17, v10, 0
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v20, v10, v[4:5]
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v18, v9, v[2:3]
; GFX9-NEXT:    v_cndmask_b32_e64 v24, 0, 1, s[4:5]
; GFX9-NEXT:    v_mad_u64_u32 v[22:23], s[6:7], v1, v9, v[6:7]
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], vcc, v19, v8, v[4:5]
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v17, v12, 0
; GFX9-NEXT:    v_addc_co_u32_e32 v24, vcc, 0, v24, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v21, v8, v[22:23]
; GFX9-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v18, v11, v[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v25, 0, 1, s[4:5]
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v19, v10, v[22:23]
; GFX9-NEXT:    v_addc_co_u32_e64 v25, s[4:5], 0, v25, s[4:5]
; GFX9-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v0, v9, v[4:5]
; GFX9-NEXT:    v_addc_co_u32_e64 v25, s[4:5], 0, v25, s[4:5]
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v20, v8, v[22:23]
; GFX9-NEXT:    v_addc_co_u32_e64 v23, s[4:5], 0, v25, s[4:5]
; GFX9-NEXT:    v_mul_lo_u32 v25, v21, v9
; GFX9-NEXT:    v_mad_u64_u32 v[21:22], s[4:5], v17, v13, v[5:6]
; GFX9-NEXT:    v_mul_lo_u32 v13, v19, v13
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[6:7], v18, v12, v[21:22]
; GFX9-NEXT:    v_mul_lo_u32 v12, v0, v12
; GFX9-NEXT:    v_mad_u64_u32 v[21:22], vcc, v19, v11, v[5:6]
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v17, v11, v[3:4]
; GFX9-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s[8:9]
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[8:9], v18, v10, v[5:6]
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[10:11], v0, v10, v[21:22]
; GFX9-NEXT:    v_addc_co_u32_e64 v21, s[8:9], 0, v11, s[8:9]
; GFX9-NEXT:    v_mad_u64_u32 v[10:11], s[8:9], v19, v9, v[3:4]
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[12:13], v20, v9, v[5:6]
; GFX9-NEXT:    v_addc_co_u32_e64 v19, s[8:9], 0, v21, s[8:9]
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v0, v8, v[10:11]
; GFX9-NEXT:    v_mad_u64_u32 v[10:11], s[14:15], v1, v8, v[3:4]
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[16:17], v17, v8, 0
; GFX9-NEXT:    v_addc_co_u32_e64 v19, s[8:9], 0, v19, s[8:9]
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[8:9], v17, v9, v[1:2]
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s[8:9]
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[8:9], v18, v8, v[3:4]
; GFX9-NEXT:    v_addc_co_u32_e64 v3, s[8:9], v9, v5, s[8:9]
; GFX9-NEXT:    v_mul_lo_u32 v9, v17, v15
; GFX9-NEXT:    v_addc_co_u32_e64 v4, s[8:9], v24, v6, s[8:9]
; GFX9-NEXT:    v_addc_co_u32_e64 v5, s[8:9], v19, v10, s[8:9]
; GFX9-NEXT:    v_addc_co_u32_e64 v6, s[8:9], v23, v11, s[8:9]
; GFX9-NEXT:    v_addc_co_u32_e64 v7, s[8:9], v7, v9, s[8:9]
; GFX9-NEXT:    v_addc_co_u32_e64 v7, s[8:9], v7, v14, s[14:15]
; GFX9-NEXT:    v_addc_co_u32_e64 v7, s[8:9], v7, v13, s[12:13]
; GFX9-NEXT:    v_addc_co_u32_e64 v7, s[8:9], v7, v12, s[10:11]
; GFX9-NEXT:    v_addc_co_u32_e32 v7, vcc, v7, v27, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v7, vcc, v7, v26, s[6:7]
; GFX9-NEXT:    v_addc_co_u32_e64 v7, vcc, v7, v25, s[4:5]
; GFX9-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v16, v8, v[7:8]
