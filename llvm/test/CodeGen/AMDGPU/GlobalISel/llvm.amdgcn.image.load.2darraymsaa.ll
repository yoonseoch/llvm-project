...
; RUN: llc -global-isel -mtriple=amdgpu6.00-mesa-mesa3d < %s | FileCheck -check-prefix=GFX6 %s
; RUN: llc -global-isel -mtriple=amdgpu10.10-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX10PLUS,GFX10 %s
; RUN: llc -global-isel -mtriple=amdgpu11.00-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX10PLUS,GFX11 %s
...
; GFX6-NEXT:    image_load v[4:8], v[0:3], s[0:7] dmask:0xf unorm tfe da
...
; GFX6-NEXT:    buffer_store_dword v8, off, s[8:11], 0
...
; GFX6-NEXT:    v_mov_b32_e32 v7, v4
; GFX6-NEXT:    v_mov_b32_e32 v8, v4
; GFX6-NEXT:    image_load v[4:8], v[0:3], s[0:7] dmask:0xf unorm tfe lwe da
; GFX6-NEXT:    s_mov_b32 s8, s10
; GFX6-NEXT:    s_mov_b32 s9, s11
; GFX6-NEXT:    s_mov_b32 s10, -1
; GFX6-NEXT:    s_mov_b32 s11, 0xf000
