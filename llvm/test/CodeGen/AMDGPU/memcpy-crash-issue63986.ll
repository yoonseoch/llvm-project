...
; CHECK-NEXT:    v_add_co_u32_e32 v2, vcc, s4, v8
; CHECK-NEXT:    v_addc_co_u32_e32 v3, vcc, v3, v9, vcc
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
...
; CHECK-NEXT:    flat_load_ubyte v6, v[4:5]
; CHECK-NEXT:    v_mov_b32_e32 v5, s5
; CHECK-NEXT:    v_add_co_u32_e32 v4, vcc, s4, v2
; CHECK-NEXT:    v_addc_co_u32_e32 v5, vcc, v3, v5, vcc
...
; CHECK-NEXT:    v_mov_b32_e32 v4, s17
; CHECK-NEXT:    v_add_co_u32_e32 v8, vcc, s16, v2
; CHECK-NEXT:    v_addc_co_u32_e32 v9, vcc, v4, v3, vcc
...
; CHECK-NEXT:    v_add_co_u32_e32 v12, vcc, s10, v10
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[12:13], v[2:5]
...
; CHECK-NEXT:    v_add_co_u32_e32 v2, vcc, s12, v0
; CHECK-NEXT:    v_addc_co_u32_e32 v3, vcc, v1, v4, vcc
; CHECK-NEXT:    flat_load_ubyte v5, v[2:3]
; CHECK-NEXT:    v_add_co_u32_e32 v2, vcc, s12, v8
; CHECK-NEXT:    s_add_u32 s12, s12, 1
; CHECK-NEXT:    s_addc_u32 s13, s13, 0
; CHECK-NEXT:    v_cmp_ge_u64_e64 s[8:9], s[12:13], v[6:7]
; CHECK-NEXT:    v_addc_co_u32_e32 v3, vcc, v9, v4, vcc
