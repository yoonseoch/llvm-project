...
; RUN: llc < %s -amdgpu-scalarize-global-loads=false  -mtriple=amdgpu6.01-- | FileCheck %s --check-prefixes=SI
...
; SI-NEXT:    v_lshl_b64 v[9:10], v[9:10], v6
; SI-NEXT:    v_lshl_b64 v[7:8], v[7:8], v4
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_lshl_b64 v[2:3], v[2:3], v13
; SI-NEXT:    v_lshl_b64 v[0:1], v[0:1], v11
