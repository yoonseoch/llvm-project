...
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    v_mov_b64_e32 v[18:19], 0
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[0:3], v[22:23], v[22:23], v[4:7]
; CHECK-NEXT:    s_mov_b32 s0, 0x7e007e00
; CHECK-NEXT:    s_mov_b32 s1, s0
; CHECK-NEXT:    v_mov_b64_e32 v[26:27], s[0:1]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[22:23], v[24:25], v[4:7]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[12:15], v[22:23], v[22:23], v[8:11]
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; def v[14:17]
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[0:3], v[22:23], v[22:23], v[0:3]
; CHECK-NEXT:    s_nop 4
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[4:7], v[22:23], v[26:27], v[4:7]
; CHECK-NEXT:    v_cvt_f16_f32_e32 v12, v12
; CHECK-NEXT:    v_cvt_f16_f32_e32 v20, v0
; CHECK-NEXT:    global_store_short v[18:19], v12, off
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[22:23], v[22:23], v[8:11]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[0:3], v[22:23], v[22:23], v[14:17]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[12:15], v[22:23], v[24:25], v[14:17]
; CHECK-NEXT:    s_nop 4
; CHECK-NEXT:    v_cvt_f16_f32_e32 v8, v8
; CHECK-NEXT:    global_store_short v[18:19], v8, off
...
; CHECK-NEXT:    global_store_short v[18:19], v4, off
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[4:7], v[24:25], v[22:23], v[6:9]
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    global_store_short v[18:19], v20, off
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[0:3], v[26:27], v[22:23], v[0:3]
; CHECK-NEXT:    v_cvt_f16_f32_e32 v4, v4
; CHECK-NEXT:    global_store_short v[18:19], v4, off
; CHECK-NEXT:    s_nop 4
...
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    global_store_short v[18:19], v0, off
; CHECK-NEXT:    s_endpgm
entry:
