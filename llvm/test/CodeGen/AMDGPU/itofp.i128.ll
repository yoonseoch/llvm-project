...
; GISEL-NEXT:    v_xor_b32_e32 v1, v5, v1
; GISEL-NEXT:    v_sub_co_u32_e32 v0, vcc, v0, v5
; GISEL-NEXT:    v_xor_b32_e32 v2, v5, v2
; GISEL-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v5, vcc
; GISEL-NEXT:    v_xor_b32_e32 v4, v5, v3
; GISEL-NEXT:    v_subb_co_u32_e32 v3, vcc, v2, v5, vcc
; GISEL-NEXT:    v_ffbh_u32_e32 v6, v0
; GISEL-NEXT:    v_subb_co_u32_e32 v4, vcc, v4, v5, vcc
; GISEL-NEXT:    v_ffbh_u32_e32 v2, v1
; GISEL-NEXT:    v_add_u32_e32 v6, 32, v6
; GISEL-NEXT:    v_ffbh_u32_e32 v7, v3
; GISEL-NEXT:    v_min_u32_e32 v2, v2, v6
; GISEL-NEXT:    v_ffbh_u32_e32 v6, v4
; GISEL-NEXT:    v_add_u32_e32 v7, 32, v7
; GISEL-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[3:4]
; GISEL-NEXT:    v_add_u32_e32 v2, 64, v2
; GISEL-NEXT:    v_min_u32_e32 v6, v6, v7
; GISEL-NEXT:    v_cndmask_b32_e32 v8, v6, v2, vcc
...
; GISEL-NEXT:    v_sub_u32_e32 v2, 0x66, v8
; GISEL-NEXT:    v_sub_u32_e32 v11, 64, v2
; GISEL-NEXT:    v_lshrrev_b64 v[9:10], v2, v[0:1]
; GISEL-NEXT:    v_lshlrev_b64 v[11:12], v11, v[3:4]
; GISEL-NEXT:    v_add_u32_e32 v13, 0xffffffc0, v2
; GISEL-NEXT:    v_or_b32_e32 v11, v9, v11
; GISEL-NEXT:    v_or_b32_e32 v12, v10, v12
; GISEL-NEXT:    v_lshrrev_b64 v[9:10], v13, v[3:4]
; GISEL-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v2
; GISEL-NEXT:    v_add_u32_e32 v14, 26, v8
...
; GISEL-NEXT:    v_and_b32_e32 v4, v10, v4
; GISEL-NEXT:    v_and_or_b32 v0, v8, v0, v3
; GISEL-NEXT:    v_and_or_b32 v1, v11, v1, v4
; GISEL-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_or_b32_e32 v1, v13, v0
; GISEL-NEXT:    v_mov_b32_e32 v0, v1
; GISEL-NEXT:    v_mov_b32_e32 v1, v2
; GISEL-NEXT:    v_mov_b32_e32 v2, v3
; GISEL-NEXT:    v_mov_b32_e32 v3, v4
...
; GISEL-NEXT:    v_bfrev_b32_e32 v3, 32
...
; GISEL-NEXT:    v_and_b32_e32 v0, 0x80000000, v5
...
; GISEL-NEXT:    v_add_u32_e32 v2, 0xffffff98, v8
...
; GISEL-NEXT:    v_xor_b32_e32 v4, v8, v2
; GISEL-NEXT:    v_sub_co_u32_e32 v2, vcc, v0, v8
; GISEL-NEXT:    v_xor_b32_e32 v5, v8, v3
; GISEL-NEXT:    v_subb_co_u32_e32 v3, vcc, v1, v8, vcc
; GISEL-NEXT:    v_subb_co_u32_e32 v4, vcc, v4, v8, vcc
; GISEL-NEXT:    v_ffbh_u32_e32 v1, v2
; GISEL-NEXT:    v_subb_co_u32_e32 v5, vcc, v5, v8, vcc
...
; GISEL-NEXT:    v_min_u32_e32 v1, v1, v6
; GISEL-NEXT:    v_cndmask_b32_e32 v11, v1, v0, vcc
; GISEL-NEXT:    v_sub_u32_e32 v9, 0x80, v11
...
; GISEL-NEXT:    s_or_saveexec_b64 s[8:9], s[4:5]
; GISEL-NEXT:    v_sub_u32_e32 v10, 0x7f, v11
; GISEL-NEXT:    s_xor_b64 exec, exec, s[8:9]
...
; GISEL-NEXT:    v_or_b32_e32 v6, v0, v6
; GISEL-NEXT:    v_or_b32_e32 v7, v1, v7
; GISEL-NEXT:    v_lshrrev_b64 v[0:1], v15, v[4:5]
; GISEL-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v14
; GISEL-NEXT:    v_add_u32_e32 v15, 55, v11
...
; GISEL-NEXT:    v_cndmask_b32_e64 v6, v1, v3, s[4:5]
; GISEL-NEXT:    v_lshrrev_b64 v[0:1], v15, -1
; GISEL-NEXT:    v_lshlrev_b64 v[12:13], v12, -1
; GISEL-NEXT:    v_add_u32_e32 v11, -9, v11
; GISEL-NEXT:    v_or_b32_e32 v16, v0, v12
; GISEL-NEXT:    v_lshrrev_b64 v[11:12], v11, -1
; GISEL-NEXT:    v_or_b32_e32 v13, v1, v13
...
; GISEL-NEXT:    v_and_or_b32 v0, v11, v2, v0
; GISEL-NEXT:    v_and_or_b32 v1, v12, v3, v1
; GISEL-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_or_b32_e32 v5, v14, v0
; GISEL-NEXT:    v_mov_b32_e32 v2, v5
; GISEL-NEXT:    v_mov_b32_e32 v3, v6
...
; GISEL-NEXT:    v_and_b32_e32 v1, 0x80000000, v8
; GISEL-NEXT:    v_lshl_add_u32 v2, v10, 20, v2
; GISEL-NEXT:    v_and_b32_e32 v3, 0xfffff, v6
; GISEL-NEXT:    v_or3_b32 v1, v3, v1, v2
; GISEL-NEXT:  .LBB2_12: ; %Flow5
; GISEL-NEXT:    s_or_b64 exec, exec, s[6:7]
; GISEL-NEXT:    s_setpc_b64 s[30:31]
; GISEL-NEXT:  .LBB2_13: ; %itofp-if-else
; GISEL-NEXT:    v_add_u32_e32 v4, 0xffffffb5, v11
...
; GISEL-NEXT:    v_lshl_or_b32 v6, v4, 29, v1
...
; GISEL-NEXT:    v_add_u32_e32 v4, 64, v4
; GISEL-NEXT:    v_min_u32_e32 v5, v5, v6
; GISEL-NEXT:    v_cndmask_b32_e32 v7, v5, v4, vcc
; GISEL-NEXT:    v_sub_u32_e32 v8, 0x80, v7
...
; GISEL-NEXT:    s_or_saveexec_b64 s[8:9], s[4:5]
; GISEL-NEXT:    v_sub_u32_e32 v9, 0x7f, v7
; GISEL-NEXT:    s_xor_b64 exec, exec, s[8:9]
...
; GISEL-NEXT:  ; %bb.5: ; %itofp-sw-default
; GISEL-NEXT:    v_sub_u32_e32 v6, 0x49, v7
; GISEL-NEXT:    v_sub_u32_e32 v10, 64, v6
; GISEL-NEXT:    v_lshrrev_b64 v[4:5], v6, v[0:1]
; GISEL-NEXT:    v_lshlrev_b64 v[10:11], v10, v[2:3]
; GISEL-NEXT:    v_add_u32_e32 v14, 0xffffffc0, v6
; GISEL-NEXT:    v_or_b32_e32 v10, v4, v10
; GISEL-NEXT:    v_or_b32_e32 v11, v5, v11
; GISEL-NEXT:    v_lshrrev_b64 v[4:5], v14, v[2:3]
; GISEL-NEXT:    v_lshrrev_b64 v[12:13], v6, v[2:3]
...
; GISEL-NEXT:    v_add_u32_e32 v15, 55, v7
...
; GISEL-NEXT:    v_sub_u32_e32 v12, 64, v15
; GISEL-NEXT:    v_cndmask_b32_e32 v6, 0, v13, vcc
; GISEL-NEXT:    v_lshrrev_b64 v[10:11], v15, -1
; GISEL-NEXT:    v_lshlrev_b64 v[12:13], v12, -1
; GISEL-NEXT:    v_add_u32_e32 v7, -9, v7
; GISEL-NEXT:    v_or_b32_e32 v16, v10, v12
; GISEL-NEXT:    v_or_b32_e32 v17, v11, v13
; GISEL-NEXT:    v_lshrrev_b64 v[12:13], v7, -1
; GISEL-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v15
; GISEL-NEXT:    v_cndmask_b32_e32 v7, v12, v16, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v13, v17, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v15
; GISEL-NEXT:    v_cndmask_b32_e32 v10, 0, v10, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v11, 0, v11, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v7, v7, -1, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v12, v12, -1, s[4:5]
; GISEL-NEXT:    v_and_b32_e32 v2, v10, v2
; GISEL-NEXT:    v_and_b32_e32 v3, v11, v3
; GISEL-NEXT:    v_and_or_b32 v0, v7, v0, v2
; GISEL-NEXT:    v_and_or_b32 v1, v12, v1, v3
; GISEL-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_or_b32_e32 v3, v14, v0
; GISEL-NEXT:    v_mov_b32_e32 v0, v3
; GISEL-NEXT:    v_mov_b32_e32 v1, v4
; GISEL-NEXT:    v_mov_b32_e32 v2, v5
; GISEL-NEXT:    v_mov_b32_e32 v3, v6
...
; GISEL-NEXT:    v_or_b32_e32 v6, v5, v6
; GISEL-NEXT:    s_and_saveexec_b64 s[4:5], vcc
...
; GISEL-NEXT:    v_lshl_add_u32 v0, v9, 20, v0
; GISEL-NEXT:    v_mov_b32_e32 v1, 0xfffff
; GISEL-NEXT:    v_and_or_b32 v5, v6, v1, v0
...
; GISEL-NEXT:    v_add_u32_e32 v2, 0xffffffb5, v7
; GISEL-NEXT:    v_lshlrev_b64 v[0:1], v2, v[0:1]
; GISEL-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v2
; GISEL-NEXT:    v_cndmask_b32_e32 v4, 0, v0, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v6, 0, v1, vcc
