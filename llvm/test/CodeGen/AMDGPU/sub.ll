...
; GFX6-NEXT:    s_mov_b64 s[6:7], s[14:15]
; GFX6-NEXT:    buffer_load_dwordx4 v[0:3], v[8:9], s[12:15], 0 addr64
; GFX6-NEXT:    buffer_load_dwordx4 v[12:15], v[8:9], s[4:7], 0 addr64
; GFX6-NEXT:    buffer_load_dwordx4 v[4:7], v[8:9], s[4:7], 0 addr64 offset:16
; GFX6-NEXT:    buffer_load_dwordx4 v[8:11], v[8:9], s[12:15], 0 addr64 offset:16
; GFX6-NEXT:    s_mov_b32 s10, -1
; GFX6-NEXT:    s_mov_b32 s8, s0
; GFX6-NEXT:    s_mov_b32 s9, s1
; GFX6-NEXT:    s_waitcnt vmcnt(2)
; GFX6-NEXT:    v_sub_i32_e32 v2, vcc, v2, v14
; GFX6-NEXT:    v_subb_u32_e32 v3, vcc, v3, v15, vcc
; GFX6-NEXT:    v_sub_i32_e32 v0, vcc, v0, v12
; GFX6-NEXT:    v_subb_u32_e32 v1, vcc, v1, v13, vcc
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    v_sub_i32_e32 v6, vcc, v10, v6
; GFX6-NEXT:    v_subb_u32_e32 v7, vcc, v11, v7, vcc
; GFX6-NEXT:    v_sub_i32_e32 v4, vcc, v8, v4
; GFX6-NEXT:    v_subb_u32_e32 v5, vcc, v9, v5, vcc
...
; GFX8-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX8-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
; GFX8-NEXT:    v_lshlrev_b32_e32 v2, 5, v0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, s2, v2
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
...
; GFX8-NEXT:    flat_load_dwordx4 v[12:15], v[4:5]
...
; GFX8-NEXT:    v_sub_u32_e32 v10, vcc, v10, v14
; GFX8-NEXT:    v_subb_u32_e32 v11, vcc, v11, v15, vcc
; GFX8-NEXT:    v_sub_u32_e32 v8, vcc, v8, v12
; GFX8-NEXT:    v_subb_u32_e32 v9, vcc, v9, v13, vcc
...
; GFX9-NEXT:    global_load_dwordx4 v[12:15], v16, s[2:3]
; GFX9-NEXT:    global_load_dwordx4 v[4:7], v16, s[2:3] offset:16
; GFX9-NEXT:    global_load_dwordx4 v[8:11], v16, s[6:7] offset:16
; GFX9-NEXT:    s_waitcnt vmcnt(2)
; GFX9-NEXT:    v_sub_co_u32_e32 v2, vcc, v14, v2
; GFX9-NEXT:    v_subb_co_u32_e32 v3, vcc, v15, v3, vcc
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v12, v0
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v13, v1, vcc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_sub_co_u32_e32 v6, vcc, v6, v10
; GFX9-NEXT:    v_subb_co_u32_e32 v7, vcc, v7, v11, vcc
; GFX9-NEXT:    v_sub_co_u32_e32 v4, vcc, v4, v8
; GFX9-NEXT:    v_mov_b32_e32 v12, 0
; GFX9-NEXT:    v_subb_co_u32_e32 v5, vcc, v5, v9, vcc
; GFX9-NEXT:    global_store_dwordx4 v12, v[4:7], s[0:1] offset:16
; GFX9-NEXT:    global_store_dwordx4 v12, v[0:3], s[0:1]
; GFX9-NEXT:    s_endpgm
;
