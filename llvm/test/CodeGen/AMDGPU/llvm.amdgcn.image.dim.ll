...
; RUN: llc -mtriple=amdgpu6.01 < %s | FileCheck -check-prefixes=VERDE %s
; RUN: llc -mtriple=amdgpu8.03 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=FIJI %s
; RUN: llc -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=GFX6789 %s
; RUN: llc -mtriple=amdgpu9.00 -mattr=-enable-prt-strict-null < %s | FileCheck -check-prefixes=NOPRT %s
; RUN: llc -mtriple=amdgpu10.10 < %s | FileCheck -check-prefixes=GFX10PLUS,GFX10 %s
; RUN: llc -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX10PLUS,GFX11 %s
; RUN: llc -mtriple=amdgpu12.00 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX12 %s
; RUN: llc -mtriple=amdgpu13.10 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX13 %s
