...
; RUN: llc -mtriple=amdgpu10.30-amd-amdhsa %s -o - | FileCheck %s
...
; CHECK-NEXT:    v_mov_b32_e32 v17, v11
; CHECK-NEXT:    v_mov_b32_e32 v16, v10
; CHECK-NEXT:    s_mov_b32 s9, 0
; CHECK-NEXT:    .p2align 6
; CHECK-NEXT:  .LBB0_5: ; %memmove_fwd_main_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    flat_load_dwordx4 v[4:7], v[12:13]
; CHECK-NEXT:    v_add_co_u32 v16, s5, v16, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v17, null, -1, v17, s5
; CHECK-NEXT:    v_add_co_u32 v12, s5, v12, 16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v13, null, 0, v13, s5
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[16:17]
; CHECK-NEXT:    s_or_b32 s9, s5, s9
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[14:15], v[4:7]
; CHECK-NEXT:    v_add_co_u32 v14, s6, v14, 16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v15, null, 0, v15, s6
...
; CHECK-NEXT:    v_add_co_u32 v0, s5, v0, v10
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v11, s5
; CHECK-NEXT:    v_add_co_u32 v2, s5, v2, v10
; CHECK-NEXT:    v_add_co_ci_u32_e64 v3, null, v3, v11, s5
; CHECK-NEXT:    s_mov_b32 s9, 0
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; CHECK-NEXT:    ; implicit-def: $vgpr10_vgpr11
...
; CHECK-NEXT:    v_add_co_u32 v6, s4, v4, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, -1, v5, s4
; CHECK-NEXT:    s_mov_b32 s8, 0
; CHECK-NEXT:    v_add_co_u32 v4, s4, v0, v6
; CHECK-NEXT:    v_add_co_ci_u32_e64 v5, null, v1, v7, s4
; CHECK-NEXT:    v_add_co_u32 v6, s4, v2, v6
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, v3, v7, s4
; CHECK-NEXT:    .p2align 6
; CHECK-NEXT:  .LBB0_12: ; %memmove_bwd_residual_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    flat_load_ubyte v12, v[6:7]
...
; CHECK-NEXT:    v_add_co_ci_u32_e64 v5, null, -1, v1, vcc_lo
; CHECK-NEXT:    v_add_co_u32 v6, vcc_lo, v2, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, -1, v3, vcc_lo
...
; CHECK-NEXT:    v_add_co_u32 v0, vcc_lo, v6, v8
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, v7, v9, vcc_lo
; CHECK-NEXT:    v_add_co_u32 v10, vcc_lo, v8, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, -1, v9, vcc_lo
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[0:1]
; CHECK-NEXT:    v_add_co_u32 v8, s4, v4, v8
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[10:11]
; CHECK-NEXT:    v_add_co_ci_u32_e64 v9, null, v5, v9, s4
...
; CHECK-NEXT:    v_add_co_ci_u32_e64 v5, null, v3, v7, s4
; CHECK-NEXT:    v_add_co_u32 v6, s4, v0, v6
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, v1, v7, s4
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:    s_or_b32 s8, s4, s8
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_byte v[6:7], v12
...
; CHECK-NEXT:  ; %bb.14: ; %memmove_bwd_main_loop.preheader
; CHECK-NEXT:    v_add_co_u32 v4, vcc_lo, v2, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v5, null, -1, v3, vcc_lo
; CHECK-NEXT:    v_add_co_u32 v6, vcc_lo, v0, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, -1, v1, vcc_lo
; CHECK-NEXT:    s_mov_b32 s7, 0
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:    v_mov_b32_e32 v8, v10
; CHECK-NEXT:    v_mov_b32_e32 v9, v11
; CHECK-NEXT:    v_add_co_u32 v0, vcc_lo, v4, v8
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, v5, v9, vcc_lo
; CHECK-NEXT:    v_add_co_u32 v10, vcc_lo, v8, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, -1, v9, vcc_lo
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[0:1], off
; CHECK-NEXT:    v_add_co_u32 v8, s4, v6, v8
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[10:11]
; CHECK-NEXT:    v_add_co_ci_u32_e64 v9, null, v7, v9, s4
; CHECK-NEXT:    s_or_b32 s7, vcc_lo, s7
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[8:9], v[0:3]
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s7
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_and_b32_e32 v10, 15, v3
...
; CHECK-NEXT:    s_mov_b32 s6, exec_lo
; CHECK-NEXT:    v_cmp_ne_u64_e64 s4, 0, v[10:11]
; CHECK-NEXT:    v_cndmask_b32_e32 v5, -1, v0, vcc_lo
; CHECK-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[8:9]
; CHECK-NEXT:    v_cmpx_ge_u32_e32 v2, v5
; CHECK-NEXT:    s_xor_b32 s7, exec_lo, s6
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_b128 v[4:7], v16
; CHECK-NEXT:    v_add_co_u32 v14, s5, v14, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v15, null, -1, v15, s5
; CHECK-NEXT:    v_add_nc_u32_e32 v16, 16, v16
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[14:15]
; CHECK-NEXT:    s_or_b32 s9, s5, s9
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[12:13], v[4:7]
; CHECK-NEXT:    v_add_co_u32 v12, s6, v12, 16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v13, null, 0, v13, s6
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s9
...
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[10:11]
; CHECK-NEXT:    s_or_b32 s9, s5, s9
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
...
; CHECK-NEXT:  ; %bb.11: ; %memmove_bwd_residual_loop.preheader
; CHECK-NEXT:    v_add_co_u32 v5, s4, v0, v3
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, v1, v4, s4
; CHECK-NEXT:    v_add3_u32 v6, v3, v2, -1
; CHECK-NEXT:    v_add_co_u32 v4, s4, v5, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v5, null, -1, v7, s4
; CHECK-NEXT:    s_mov_b32 s8, 0
; CHECK-NEXT:    .p2align 6
; CHECK-NEXT:  .LBB2_12: ; %memmove_bwd_residual_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_u8 v7, v6
; CHECK-NEXT:    v_add_co_u32 v10, s4, v10, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, -1, v11, s4
; CHECK-NEXT:    v_add_nc_u32_e32 v6, -1, v6
; CHECK-NEXT:    v_cmp_eq_u64_e64 s4, 0, v[10:11]
; CHECK-NEXT:    s_or_b32 s8, s4, s8
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    flat_store_byte v[4:5], v7
; CHECK-NEXT:    v_add_co_u32 v4, s5, v4, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v5, null, -1, v5, s5
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s8
...
; CHECK-NEXT:  ; %bb.14: ; %memmove_bwd_main_loop.preheader
; CHECK-NEXT:    v_and_b32_e32 v3, -16, v3
; CHECK-NEXT:    v_add_co_u32 v5, vcc_lo, v0, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v6, null, -1, v1, vcc_lo
; CHECK-NEXT:    v_add3_u32 v4, v3, v2, -16
; CHECK-NEXT:    s_mov_b32 s7, 0
; CHECK-NEXT:    .p2align 6
; CHECK-NEXT:  .LBB2_15: ; %memmove_bwd_main_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_b128 v[0:3], v4
...
; CHECK-NEXT:    v_add_co_u32 v10, s4, v5, v10
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, v6, v11, s4
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[8:9]
; CHECK-NEXT:    s_or_b32 s7, vcc_lo, s7
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[10:11], v[0:3]
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s7
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    global_load_ubyte v12, v[6:7], off
; CHECK-NEXT:    v_add_co_u32 v8, s4, v8, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v9, null, -1, v9, s4
; CHECK-NEXT:    v_add_co_u32 v6, s4, v6, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, -1, v7, s4
...
; CHECK-NEXT:    buffer_load_dword v4, v16, s[0:3], 0 offen
; CHECK-NEXT:    buffer_load_dword v5, v16, s[0:3], 0 offen offset:4
; CHECK-NEXT:    buffer_load_dword v6, v16, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_load_dword v7, v16, s[0:3], 0 offen offset:12
; CHECK-NEXT:    v_add_co_u32 v14, s5, v14, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v15, null, -1, v15, s5
; CHECK-NEXT:    v_add_nc_u32_e32 v16, 16, v16
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[14:15]
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    buffer_load_ubyte v7, v6, s[0:3], 0 offen
; CHECK-NEXT:    v_add_co_u32 v10, s4, v10, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, -1, v11, s4
; CHECK-NEXT:    v_add_nc_u32_e32 v6, -1, v6
; CHECK-NEXT:    v_cmp_eq_u64_e64 s4, 0, v[10:11]
...
; CHECK-NEXT:    buffer_load_dword v2, v4, s[0:3], 0 offen offset:8
...
; CHECK-NEXT:    s_or_b32 s9, s5, s9
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_dwordx4 v[14:15], v[4:7], off
; CHECK-NEXT:    v_add_co_u32 v14, s6, v14, 16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v15, null, 0, v15, s6
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s9
...
; CHECK-NEXT:    v_and_b32_e32 v9, 15, v3
; CHECK-NEXT:    v_mov_b32_e32 v10, 0
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    s_mov_b32 s6, exec_lo
; CHECK-NEXT:    v_cmpx_ne_u64_e32 0, v[11:12]
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_b128 v[5:8], v13
...
; CHECK-NEXT:    v_cmp_ge_u64_e32 vcc_lo, s[4:5], v[11:12]
; CHECK-NEXT:    s_or_b32 s7, vcc_lo, s7
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    global_store_dwordx4 v[14:15], v[5:8], off
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s7
...
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    s_mov_b32 s6, exec_lo
; CHECK-NEXT:    v_cmpx_ne_u64_e32 0, v[9:10]
...
; CHECK-NEXT:    s_addc_u32 s5, s5, 0
; CHECK-NEXT:    v_add_nc_u32_e32 v2, 1, v2
; CHECK-NEXT:    v_cmp_ge_u64_e32 vcc_lo, s[4:5], v[9:10]
; CHECK-NEXT:    s_or_b32 s7, vcc_lo, s7
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    s_clause 0x3
; CHECK-NEXT:    buffer_load_dword v5, v13, s[0:3], 0 offen
; CHECK-NEXT:    buffer_load_dword v6, v13, s[0:3], 0 offen offset:4
; CHECK-NEXT:    buffer_load_dword v7, v13, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_load_dword v8, v13, s[0:3], 0 offen offset:12
; CHECK-NEXT:    v_add_co_u32 v14, vcc_lo, v0, s4
; CHECK-NEXT:    s_add_u32 s4, s4, 16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v15, null, s5, v1, vcc_lo
; CHECK-NEXT:    s_addc_u32 s5, s5, 0
...
; CHECK-NEXT:    s_mov_b32 s6, exec_lo
; CHECK-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[10:11]
; CHECK-NEXT:    v_cmpx_ge_u64_e32 v[1:2], v[5:6]
; CHECK-NEXT:    s_xor_b32 s7, exec_lo, s6
...
; CHECK-NEXT:    v_mov_b32_e32 v15, v11
; CHECK-NEXT:    v_mov_b32_e32 v14, v10
...
; CHECK-NEXT:    v_add_co_u32 v12, s5, v12, 16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v13, null, 0, v13, s5
; CHECK-NEXT:    v_cmp_eq_u64_e64 s6, 0, v[14:15]
; CHECK-NEXT:    s_or_b32 s9, s6, s9
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_write_b128 v16, v[4:7]
; CHECK-NEXT:    v_add_nc_u32_e32 v16, 16, v16
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s9
...
; CHECK-NEXT:    v_add_co_u32 v0, s5, v1, v10
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, v2, v11, s5
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:  ; %bb.11: ; %memmove_bwd_residual_loop.preheader
; CHECK-NEXT:    v_add_co_u32 v5, s4, v1, v3
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, v2, v4, s4
; CHECK-NEXT:    v_add3_u32 v6, v3, v0, -1
; CHECK-NEXT:    v_add_co_u32 v4, s4, v5, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v5, null, -1, v7, s4
; CHECK-NEXT:    s_mov_b32 s8, 0
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    flat_load_ubyte v7, v[4:5]
; CHECK-NEXT:    v_add_co_u32 v8, s4, v8, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v9, null, -1, v9, s4
; CHECK-NEXT:    v_add_co_u32 v4, s4, v4, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v5, null, -1, v5, s4
...
; CHECK-NEXT:  ; %bb.14: ; %memmove_bwd_main_loop.preheader
; CHECK-NEXT:    v_and_b32_e32 v3, -16, v3
; CHECK-NEXT:    v_add_co_u32 v5, vcc_lo, v1, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v6, null, -1, v2, vcc_lo
; CHECK-NEXT:    v_add3_u32 v4, v3, v0, -16
; CHECK-NEXT:    s_mov_b32 s5, 0
; CHECK-NEXT:    .p2align 6
; CHECK-NEXT:  .LBB10_15: ; %memmove_bwd_main_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    v_add_co_u32 v0, vcc_lo, v5, v10
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, v6, v11, vcc_lo
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    v_add_co_u32 v5, vcc_lo, v1, s4
; CHECK-NEXT:    v_add_co_ci_u32_e64 v6, null, s5, v2, vcc_lo
; CHECK-NEXT:    s_add_u32 s4, s4, 16
; CHECK-NEXT:    s_addc_u32 s5, s5, 0
; CHECK-NEXT:    v_cmp_ge_u64_e32 vcc_lo, s[4:5], v[11:12]
; CHECK-NEXT:    global_load_dwordx4 v[5:8], v[5:6], off
; CHECK-NEXT:    s_or_b32 s7, vcc_lo, s7
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    ds_write_b128 v13, v[5:8]
; CHECK-NEXT:    v_add_nc_u32_e32 v13, 16, v13
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s7
...
; CHECK-NEXT:    v_and_b32_e32 v7, 15, v2
; CHECK-NEXT:    v_and_b32_e32 v9, -16, v2
; CHECK-NEXT:    v_mov_b32_e32 v10, v3
; CHECK-NEXT:    s_mov_b32 s6, exec_lo
; CHECK-NEXT:    v_cmp_ne_u64_e64 s4, 0, v[7:8]
; CHECK-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[9:10]
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_b128 v[3:6], v11
...
; CHECK-NEXT:    s_or_b32 s8, s5, s8
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    ds_write_b128 v12, v[3:6]
...
; CHECK-NEXT:    v_add_nc_u32_e32 v4, -16, v2
; CHECK-NEXT:    v_add_nc_u32_e32 v6, v0, v4
; CHECK-NEXT:    v_add_nc_u32_e32 v7, v1, v4
; CHECK-NEXT:    v_sub_co_u32 v4, vcc_lo, 0, v2
; CHECK-NEXT:    v_sub_co_ci_u32_e64 v5, null, 0, v3, vcc_lo
; CHECK-NEXT:  .LBB12_15: ; %memmove_bwd_main_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_b128 v[0:3], v7
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    ds_write_b128 v6, v[0:3]
...
; CHECK-NEXT:    v_and_b32_e32 v9, 15, v4
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    s_clause 0x3
; CHECK-NEXT:    buffer_load_dword v5, v11, s[0:3], 0 offen
; CHECK-NEXT:    buffer_load_dword v6, v11, s[0:3], 0 offen offset:4
; CHECK-NEXT:    buffer_load_dword v7, v11, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_load_dword v8, v11, s[0:3], 0 offen offset:12
; CHECK-NEXT:    s_add_u32 s4, s4, 16
; CHECK-NEXT:    s_addc_u32 s5, s5, 0
; CHECK-NEXT:    v_add_nc_u32_e32 v11, 16, v11
...
; CHECK-NEXT:    s_or_b32 s7, vcc_lo, s7
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    ds_write_b128 v12, v[5:8]
; CHECK-NEXT:    v_add_nc_u32_e32 v12, 16, v12
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s7
...
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[14:15]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    buffer_store_dword v7, v16, s[0:3], 0 offen offset:12
; CHECK-NEXT:    buffer_store_dword v6, v16, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_store_dword v5, v16, s[0:3], 0 offen offset:4
; CHECK-NEXT:    buffer_store_dword v4, v16, s[0:3], 0 offen
; CHECK-NEXT:    v_add_nc_u32_e32 v16, 16, v16
; CHECK-NEXT:    s_or_b32 s8, s5, s8
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s8
...
; CHECK-NEXT:    s_or_b32 s8, s5, s8
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    buffer_store_byte v7, v6, s[0:3], 0 offen
; CHECK-NEXT:    v_add_nc_u32_e32 v6, -1, v6
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s8
...
; CHECK-NEXT:    global_load_dwordx4 v[5:8], v[5:6], off
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_store_dword v8, v13, s[0:3], 0 offen offset:12
; CHECK-NEXT:    buffer_store_dword v7, v13, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_store_dword v6, v13, s[0:3], 0 offen offset:4
; CHECK-NEXT:    buffer_store_dword v5, v13, s[0:3], 0 offen
; CHECK-NEXT:    v_add_nc_u32_e32 v13, 16, v13
; CHECK-NEXT:    s_or_b32 s7, vcc_lo, s7
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s7
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_b128 v[5:8], v11
; CHECK-NEXT:    s_add_u32 s4, s4, 16
; CHECK-NEXT:    s_addc_u32 s5, s5, 0
; CHECK-NEXT:    v_add_nc_u32_e32 v11, 16, v11
; CHECK-NEXT:    v_cmp_ge_u64_e32 vcc_lo, s[4:5], v[2:3]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    buffer_store_dword v8, v12, s[0:3], 0 offen offset:12
; CHECK-NEXT:    buffer_store_dword v7, v12, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_store_dword v6, v12, s[0:3], 0 offen offset:4
; CHECK-NEXT:    buffer_store_dword v5, v12, s[0:3], 0 offen
; CHECK-NEXT:    v_add_nc_u32_e32 v12, 16, v12
; CHECK-NEXT:    s_or_b32 s7, vcc_lo, s7
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s7
