...
; RUN: llc -global-isel=0 -mtriple=amdgpu9.08 < %s | FileCheck --check-prefixes=GCN,GFX908 %s
; RUN: llc -global-isel=0 -mtriple=amdgpu9.0a < %s | FileCheck --check-prefixes=GCN,GFX90A %s
; RUN: llc -global-isel -mtriple=amdgpu9.0a < %s | FileCheck --check-prefixes=GCN,GFX90A %s
; RUN: llc -global-isel=0 -mtriple=amdgpu9.42 < %s | FileCheck --check-prefixes=GCN,GFX90A %s
; RUN: llc -global-isel -mtriple=amdgpu9.42 < %s | FileCheck --check-prefixes=GCN,GFX90A %s
...
; GFX908-NEXT:    s_nop 15
; GFX908-NEXT:    s_nop 1
; GFX908-NEXT:    v_accvgpr_read_b32 v11, a27
; GFX908-NEXT:    v_accvgpr_read_b32 v10, a26
; GFX908-NEXT:    v_accvgpr_read_b32 v9, a25
; GFX908-NEXT:    v_accvgpr_read_b32 v8, a24
; GFX908-NEXT:    v_accvgpr_read_b32 v3, a31
; GFX908-NEXT:    v_accvgpr_read_b32 v2, a30
; GFX908-NEXT:    v_accvgpr_read_b32 v1, a29
; GFX908-NEXT:    v_accvgpr_read_b32 v0, a28
; GFX908-NEXT:    v_accvgpr_read_b32 v7, a19
; GFX908-NEXT:    v_accvgpr_read_b32 v6, a18
; GFX908-NEXT:    v_accvgpr_read_b32 v5, a17
; GFX908-NEXT:    v_accvgpr_read_b32 v4, a16
; GFX908-NEXT:    v_accvgpr_read_b32 v15, a23
; GFX908-NEXT:    v_accvgpr_read_b32 v14, a22
; GFX908-NEXT:    v_accvgpr_read_b32 v13, a21
; GFX908-NEXT:    v_accvgpr_read_b32 v12, a20
...
; GFX908-NEXT:    v_accvgpr_read_b32 v25, a1
; GFX908-NEXT:    v_accvgpr_read_b32 v24, a0
; GFX908-NEXT:    global_store_dwordx4 v40, v[8:11], s[34:35] offset:96
; GFX908-NEXT:    s_nop 0
...
; GFX908-NEXT:    global_store_dwordx4 v40, v[4:7], s[34:35] offset:64
...
; GFX908-NEXT:    global_store_dwordx4 v40, v[8:11], s[34:35] offset:16
; GFX908-NEXT:    s_endpgm
bb:
  call void @foo()
  %in.1 = load <32 x float>, ptr addrspace(1) %arg
