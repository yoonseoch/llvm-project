...
; RUN: llc -mtriple=amdgpu6.00 < %s | FileCheck --check-prefix=GCN-NOHSA-SI %s
; RUN: llc -mtriple=amdgpu7.00--amdhsa < %s | FileCheck --check-prefix=GCN-HSA %s
; RUN: llc -mtriple=amdgpu8.02 < %s | FileCheck --check-prefix=GCN-NOHSA-VI %s
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s0
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s1
; GCN-HSA-NEXT:    flat_store_dwordx4 v[6:7], v[2:5]
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v0, s0
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v1, s1
; GCN-NOHSA-VI-NEXT:    flat_store_dwordx4 v[6:7], v[2:5]
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s33
; GCN-HSA-NEXT:    s_addc_u32 s1, s17, 0
...
; GCN-HSA-NEXT:    s_addc_u32 s1, s17, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v6, s11
; GCN-HSA-NEXT:    v_mov_b32_e32 v7, s28
; GCN-HSA-NEXT:    flat_store_dwordx4 v[15:16], v[0:3]
; GCN-HSA-NEXT:    flat_store_dwordx4 v[17:18], v[4:7]
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s6
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s1
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s0
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, s9
; GCN-HSA-NEXT:    v_mov_b32_e32 v11, s26
; GCN-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
...
; GFX12-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v5, s14
; GFX12-NEXT:    v_dual_mov_b32 v4, s34 :: v_dual_mov_b32 v7, s33
; GFX12-NEXT:    v_dual_mov_b32 v6, s15 :: v_dual_mov_b32 v9, s31
; GFX12-NEXT:    s_lshr_b32 s29, s10, 16
; GFX12-NEXT:    v_dual_mov_b32 v8, s12 :: v_dual_mov_b32 v11, s30
; GFX12-NEXT:    v_dual_mov_b32 v10, s13 :: v_dual_mov_b32 v1, s29
...
; GFX12-NEXT:    v_dual_mov_b32 v0, s10 :: v_dual_mov_b32 v3, s28
...
; GFX12-NEXT:    s_and_b32 s4, s4, 0xffff
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v24, v[4:7], s[16:17] offset:112
; GFX12-NEXT:    global_store_b128 v24, v[8:11], s[16:17] offset:96
; GFX12-NEXT:    v_dual_mov_b32 v4, s8 :: v_dual_mov_b32 v7, s26
; GFX12-NEXT:    v_dual_mov_b32 v5, s27 :: v_dual_mov_b32 v6, s9
...
; GFX12-NEXT:    v_dual_mov_b32 v8, s6 :: v_dual_mov_b32 v11, s24
; GFX12-NEXT:    v_dual_mov_b32 v10, s7 :: v_dual_mov_b32 v13, s23
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v11, s15
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s35
; GCN-HSA-NEXT:    s_addc_u32 s1, s17, 0
; GCN-HSA-NEXT:    s_sext_i32_i16 s10, s10
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, s9
; GCN-HSA-NEXT:    v_mov_b32_e32 v11, s28
; GCN-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s16
...
; GFX12-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v5, s34
; GFX12-NEXT:    v_dual_mov_b32 v4, s14 :: v_dual_mov_b32 v7, s33
; GFX12-NEXT:    v_dual_mov_b32 v6, s15 :: v_dual_mov_b32 v9, s31
...
; GCN-HSA:       ; %bb.0:
; GCN-HSA-NEXT:    s_load_dwordx4 s[36:39], s[8:9], 0x0
; GCN-HSA-NEXT:    s_add_i32 s12, s12, s17
; GCN-HSA-NEXT:    s_mov_b32 flat_scratch_lo, s13
; GCN-HSA-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-HSA-NEXT:    s_and_b32 s10, s10, 0xffff
; GCN-HSA-NEXT:    s_and_b32 s13, s13, 0xffff
; GCN-HSA-NEXT:    s_and_b32 s38, s12, 0xffff
; GCN-HSA-NEXT:    s_and_b32 s12, s15, 0xffff
; GCN-HSA-NEXT:    s_and_b32 s15, s14, 0xffff
; GCN-HSA-NEXT:    s_lshr_b32 s14, s17, 16
; GCN-HSA-NEXT:    s_lshr_b32 s39, s16, 16
; GCN-HSA-NEXT:    s_lshr_b32 s53, s19, 16
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v17, s16
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v11, s29
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s62
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s30
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v9, s56
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, s21
; GCN-HSA-NEXT:    v_mov_b32_e32 v11, s55
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s54
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s38
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s52
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s51
; GCN-HSA-NEXT:    v_mov_b32_e32 v17, s50
...
; GCN-HSA-NEXT:    s_ashr_i32 s49, s13, 16
; GCN-HSA-NEXT:    s_ashr_i32 s50, s12, 16
; GCN-HSA-NEXT:    s_ashr_i32 s38, s15, 16
; GCN-HSA-NEXT:    s_ashr_i32 s39, s14, 16
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v11, s29
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s65
; GCN-HSA-NEXT:    s_addc_u32 s19, s37, 0
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s24
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s62
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s25
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s30
; GCN-HSA-NEXT:    v_mov_b32_e32 v14, s68
; GCN-HSA-NEXT:    v_mov_b32_e32 v15, s31
...
; GFX12-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v9, s29
; GFX12-NEXT:    s_lshr_b32 s10, s10, 16
; GFX12-NEXT:    v_dual_mov_b32 v0, s22 :: v_dual_mov_b32 v15, s31
; GFX12-NEXT:    v_dual_mov_b32 v14, s30 :: v_dual_mov_b32 v17, s35
; GFX12-NEXT:    v_dual_mov_b32 v16, s34 :: v_dual_mov_b32 v11, s9
...
; GFX12-NEXT:    v_dual_mov_b32 v8, s28 :: v_dual_mov_b32 v1, s23
; GFX12-NEXT:    v_dual_mov_b32 v10, s8 :: v_dual_mov_b32 v5, s25
...
; GFX12-NEXT:    v_dual_mov_b32 v6, s26 :: v_dual_mov_b32 v3, s11
; GFX12-NEXT:    s_bfe_i64 s[2:3], s[4:5], 0x100000
; GFX12-NEXT:    s_lshr_b32 s4, s4, 16
; GFX12-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v2, s10 :: v_dual_mov_b32 v13, s19
; GFX12-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x100000
; GFX12-NEXT:    v_mov_b32_e32 v12, s18
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v24, v[14:17], s[0:1] offset:80
; GFX12-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:64
; GFX12-NEXT:    v_dual_mov_b32 v14, s20 :: v_dual_mov_b32 v9, s17
; GFX12-NEXT:    v_mov_b32_e32 v15, s21
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v8, s16 :: v_dual_mov_b32 v11, s7
; GFX12-NEXT:    v_dual_mov_b32 v10, s6 :: v_dual_mov_b32 v17, s13
; GFX12-NEXT:    v_dual_mov_b32 v16, s12 :: v_dual_mov_b32 v19, s15
; GFX12-NEXT:    v_dual_mov_b32 v18, s14 :: v_dual_mov_b32 v21, s3
...
; GFX12-NEXT:    global_store_b128 v24, v[12:15], s[0:1] offset:48
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v3, s47
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[12:15], off, s[0:3], 0 offset:240
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v14, s27
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x100000
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:224
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v0, s12
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v3, s37
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v6, s45
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v6, s69
; GCN-HSA-NEXT:    v_mov_b32_e32 v7, s68
; GCN-HSA-NEXT:    s_addc_u32 s43, s17, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[22:23], v[4:7]
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s73
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s72
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s71
; GCN-HSA-NEXT:    v_mov_b32_e32 v19, s70
; GCN-HSA-NEXT:    flat_store_dwordx4 v[26:27], v[0:3]
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s38
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s59
; GCN-HSA-NEXT:    v_mov_b32_e32 v17, s57
; GCN-HSA-NEXT:    v_mov_b32_e32 v19, s39
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s43
; GCN-HSA-NEXT:    v_mov_b32_e32 v20, s55
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s28
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s29
; GCN-HSA-NEXT:    v_mov_b32_e32 v26, s30
; GCN-HSA-NEXT:    v_mov_b32_e32 v27, s31
